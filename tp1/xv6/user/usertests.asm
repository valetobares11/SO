...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4ec:	3c2080e7          	jalr	962(ra) # 58aa <open>
     4f0:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    n = write(fds[1], "x", 1);
     ...
     52c:	362080e7          	jalr	866(ra) # 588a <write>
    if(n != 1){
     530:	4785                	li	a5,1
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     594:	2da080e7          	jalr	730(ra) # 586a <exit>
     ...
     5b2:	2bc080e7          	jalr	700(ra) # 586a <exit>
      printf("pipe() failed\n");
     ...
     5cc:	2a2080e7          	jalr	674(ra) # 586a <exit>
     ...
     5e6:	288080e7          	jalr	648(ra) # 586a <exit>
     ...
     604:	26a080e7          	jalr	618(ra) # 586a <exit>
...
0000000000000608 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     628:	296080e7          	jalr	662(ra) # 58ba <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     63c:	272080e7          	jalr	626(ra) # 58aa <open>
     640:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     642:	4611                	li	a2,4
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     698:	216080e7          	jalr	534(ra) # 58aa <open>
     69c:	89aa                	mv	s3,a0
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     6d4:	1b2080e7          	jalr	434(ra) # 5882 <read>
     6d8:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  unlink("truncfile");
     ...
     72c:	192080e7          	jalr	402(ra) # 58ba <unlink>
  close(fd1);
     730:	854e                	mv	a0,s3
     732:	00005097          	auipc	ra,0x5
     736:	160080e7          	jalr	352(ra) # 5892 <close>
  close(fd2);
     73a:	8526                	mv	a0,s1
     73c:	00005097          	auipc	ra,0x5
     740:	156080e7          	jalr	342(ra) # 5892 <close>
  close(fd3);
     744:	854a                	mv	a0,s2
     746:	00005097          	auipc	ra,0x5
     74a:	14c080e7          	jalr	332(ra) # 5892 <close>
}
    ...
    exit(1);
     ...
     77a:	0f4080e7          	jalr	244(ra) # 586a <exit>
    printf("aaa fd3=%d\n", fd3);
     77e:	85ca                	mv	a1,s2
    ...
    exit(1);
     ...
     7aa:	0c4080e7          	jalr	196(ra) # 586a <exit>
    printf("bbb fd2=%d\n", fd2);
     7ae:	85a6                	mv	a1,s1
    ...
    exit(1);
     ...
     7da:	094080e7          	jalr	148(ra) # 586a <exit>
    ...
    exit(1);
     ...
     7f8:	076080e7          	jalr	118(ra) # 586a <exit>
    ...
    exit(1);
     ...
     816:	058080e7          	jalr	88(ra) # 586a <exit>
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     840:	06e080e7          	jalr	110(ra) # 58aa <open>
  if(fd < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     86a:	024080e7          	jalr	36(ra) # 588a <write>
     86e:	47a9                	li	a5,10
    ...
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     ...
     87e:	010080e7          	jalr	16(ra) # 588a <write>
     882:	47a9                	li	a5,10
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8c0:	fc6080e7          	jalr	-58(ra) # 5882 <read>
  if(i != N*SZ*2){
  ...
  if(unlink("small") < 0){
    ...
    exit(1);
     ...
     916:	f58080e7          	jalr	-168(ra) # 586a <exit>
     ...
     934:	f3a080e7          	jalr	-198(ra) # 586a <exit>
     ...
     952:	f1c080e7          	jalr	-228(ra) # 586a <exit>
    ...
    exit(1);
     ...
     96e:	f00080e7          	jalr	-256(ra) # 586a <exit>
    ...
    exit(1);
     ...
     98a:	ee4080e7          	jalr	-284(ra) # 586a <exit>
    ...
    exit(1);
     ...
     9a6:	ec8080e7          	jalr	-312(ra) # 586a <exit>
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9ce:	ee0080e7          	jalr	-288(ra) # 58aa <open>
     9d2:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     9d4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, BSIZE) != BSIZE){
     ...
     9f6:	e98080e7          	jalr	-360(ra) # 588a <write>
  ...
  if(fd < 0){
    ...
    i = read(fd, buf, BSIZE);
     ...
     a40:	e46080e7          	jalr	-442(ra) # 5882 <read>
    if(i == 0){
    ...
    exit(1);
     ...
     a72:	dfc080e7          	jalr	-516(ra) # 586a <exit>
     ...
     a90:	dde080e7          	jalr	-546(ra) # 586a <exit>
    ...
    exit(1);
     ...
     aac:	dc2080e7          	jalr	-574(ra) # 586a <exit>
      if(n == MAXFILE - 1){
  ...
  if(unlink("big") < 0){
     ...
     b04:	d6a080e7          	jalr	-662(ra) # 586a <exit>
     ...
     b22:	d4c080e7          	jalr	-692(ra) # 586a <exit>
     ...
     b40:	d2e080e7          	jalr	-722(ra) # 586a <exit>
    ...
    exit(1);
     ...
     b5c:	d12080e7          	jalr	-750(ra) # 586a <exit>
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b80:	d2e080e7          	jalr	-722(ra) # 58aa <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
     ...
     bca:	cf4080e7          	jalr	-780(ra) # 58ba <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     be0:	cce080e7          	jalr	-818(ra) # 58aa <open>
     be4:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     be6:	460d                	li	a2,3
     ...
     bf4:	c9a080e7          	jalr	-870(ra) # 588a <write>
  close(fd1);
     bf8:	854a                	mv	a0,s2
     bfa:	00005097          	auipc	ra,0x5
     bfe:	c98080e7          	jalr	-872(ra) # 5892 <close>
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c12:	c74080e7          	jalr	-908(ra) # 5882 <read>
     c16:	4795                	li	a5,5
  ...
  unlink("unlinkread");
    ...
    exit(1);
     ...
     c86:	be8080e7          	jalr	-1048(ra) # 586a <exit>
    ...
    exit(1);
     ...
     ca2:	bcc080e7          	jalr	-1076(ra) # 586a <exit>
    ...
    exit(1);
     ...
     cbe:	bb0080e7          	jalr	-1104(ra) # 586a <exit>
    ...
    exit(1);
     ...
     cda:	b94080e7          	jalr	-1132(ra) # 586a <exit>
    ...
    exit(1);
     ...
     cf6:	b78080e7          	jalr	-1160(ra) # 586a <exit>
    ...
    exit(1);
     ...
     d12:	b5c080e7          	jalr	-1188(ra) # 586a <exit>
...
0000000000000d16 <linktest>:
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
     ...
     d54:	b5a080e7          	jalr	-1190(ra) # 58aa <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d6c:	b22080e7          	jalr	-1246(ra) # 588a <write>
     d70:	4795                	li	a5,5
     d72:	10f51863          	bne	a0,a5,e82 <linktest+0x16c>
  close(fd);
     d76:	8526                	mv	a0,s1
     d78:	00005097          	auipc	ra,0x5
     d7c:	b1a080e7          	jalr	-1254(ra) # 5892 <close>
  if(link("lf1", "lf2") < 0){
     ...
     d94:	b3a080e7          	jalr	-1222(ra) # 58ca <link>
  ...
  fd = open("lf2", 0);
     ...
     dd0:	ade080e7          	jalr	-1314(ra) # 58aa <open>
     dd4:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  unlink("lf2");
     ...
     e1e:	aa0080e7          	jalr	-1376(ra) # 58ba <unlink>
  if(link("lf2", "lf1") >= 0){
     ...
     e36:	a98080e7          	jalr	-1384(ra) # 58ca <link>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e52:	a7c080e7          	jalr	-1412(ra) # 58ca <link>
    ...
    exit(1);
     ...
     e7e:	9f0080e7          	jalr	-1552(ra) # 586a <exit>
    ...
    exit(1);
     ...
     e9a:	9d4080e7          	jalr	-1580(ra) # 586a <exit>
    ...
    exit(1);
     ...
     eb6:	9b8080e7          	jalr	-1608(ra) # 586a <exit>
    ...
    exit(1);
     ...
     ed2:	99c080e7          	jalr	-1636(ra) # 586a <exit>
    ...
    exit(1);
     ...
     eee:	980080e7          	jalr	-1664(ra) # 586a <exit>
    ...
    exit(1);
     ...
     f0a:	964080e7          	jalr	-1692(ra) # 586a <exit>
    ...
    exit(1);
     ...
     f26:	948080e7          	jalr	-1720(ra) # 586a <exit>
    ...
    exit(1);
     ...
     f42:	92c080e7          	jalr	-1748(ra) # 586a <exit>
    ...
    exit(1);
     ...
     f5e:	910080e7          	jalr	-1776(ra) # 586a <exit>
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ff2:	8dc080e7          	jalr	-1828(ra) # 58ca <link>
     ff6:	84aa                	mv	s1,a0
  ...
  unlink("bd");
    ...
    100c:	8b2080e7          	jalr	-1870(ra) # 58ba <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    104e:	870080e7          	jalr	-1936(ra) # 58ba <unlink>
  ...
  for(i = 0; i < N; i++){
    ...
    1086:	7e8080e7          	jalr	2024(ra) # 586a <exit>
    ...
    10a6:	7c8080e7          	jalr	1992(ra) # 586a <exit>
    ...
    10c2:	7ac080e7          	jalr	1964(ra) # 586a <exit>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10f6:	7d8080e7          	jalr	2008(ra) # 58ca <link>
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1130:	73e080e7          	jalr	1854(ra) # 586a <exit>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1154:	752080e7          	jalr	1874(ra) # 58a2 <exec>

  pipe((int*)0xeaeb0b5b00002f5e);
    1158:	8526                	mv	a0,s1
    115a:	00004097          	auipc	ra,0x4
    115e:	720080e7          	jalr	1824(ra) # 587a <pipe>

  exit(0);
    1162:	4501                	li	a0,0
    1164:	00004097          	auipc	ra,0x4
    1168:	706080e7          	jalr	1798(ra) # 586a <exit>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    11a0:	706080e7          	jalr	1798(ra) # 58a2 <exec>
  for(int i = 0; i < 50000; i++){
  ...
  exit(0);
    ...
    11ae:	6c0080e7          	jalr	1728(ra) # 586a <exit>
...
00000000000011b2 <copyinstr2>:
{
  ...
  int ret = unlink(b);
    ...
    11dc:	6e2080e7          	jalr	1762(ra) # 58ba <unlink>
  if(ret != -1){
    11e0:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    11f2:	6bc080e7          	jalr	1724(ra) # 58aa <open>
  if(fd != -1){
    11f6:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    1206:	6c8080e7          	jalr	1736(ra) # 58ca <link>
  if(ret != -1){
    120a:	57fd                	li	a5,-1
  ...
  if(pid == 0){
    ...
    129c:	60a080e7          	jalr	1546(ra) # 58a2 <exec>
    if(ret != -1){
    12a0:	57fd                	li	a5,-1
    ...
    12be:	5b0080e7          	jalr	1456(ra) # 586a <exit>
    ...
    12de:	590080e7          	jalr	1424(ra) # 586a <exit>
    ...
    12fe:	570080e7          	jalr	1392(ra) # 586a <exit>
    ...
    1320:	54e080e7          	jalr	1358(ra) # 586a <exit>
    ...
    1340:	52e080e7          	jalr	1326(ra) # 586a <exit>
    printf("fork failed\n");
  ...
  if(st != 747){
    ...
    13a4:	4ca080e7          	jalr	1226(ra) # 586a <exit>
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13cc:	4e2080e7          	jalr	1250(ra) # 58aa <open>
    13d0:	00004097          	auipc	ra,0x4
    13d4:	4c2080e7          	jalr	1218(ra) # 5892 <close>
  pid = fork();
    13d8:	00004097          	auipc	ra,0x4
    13dc:	48a080e7          	jalr	1162(ra) # 5862 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    1402:	4ac080e7          	jalr	1196(ra) # 58aa <open>
    1406:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    1414:	47a080e7          	jalr	1146(ra) # 588a <write>
      if(n != 10){
    1418:	47a9                	li	a5,10
    ...
    1424:	472080e7          	jalr	1138(ra) # 5892 <close>
      fd = open("truncfile", O_RDONLY);
    1428:	4581                	li	a1,0
    142a:	8552                	mv	a0,s4
    142c:	00004097          	auipc	ra,0x4
    1430:	47e080e7          	jalr	1150(ra) # 58aa <open>
    1434:	84aa                	mv	s1,a0
      read(fd, buf, sizeof(buf));
    1436:	02000613          	li	a2,32
    143a:	f9840593          	addi	a1,s0,-104
    143e:	00004097          	auipc	ra,0x4
    1442:	444080e7          	jalr	1092(ra) # 5882 <read>
      close(fd);
    1446:	8526                	mv	a0,s1
    1448:	00004097          	auipc	ra,0x4
    144c:	44a080e7          	jalr	1098(ra) # 5892 <close>
    for(int i = 0; i < 100; i++){
    ...
    145c:	412080e7          	jalr	1042(ra) # 586a <exit>
    ...
    1478:	3f6080e7          	jalr	1014(ra) # 586a <exit>
    ...
    1494:	3da080e7          	jalr	986(ra) # 586a <exit>
    ...
    14b2:	3bc080e7          	jalr	956(ra) # 586a <exit>
    ...
    14d4:	3da080e7          	jalr	986(ra) # 58aa <open>
    14d8:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    14e6:	3a8080e7          	jalr	936(ra) # 588a <write>
    if(n != 3){
    14ea:	478d                	li	a5,3
    ...
    14f6:	3a0080e7          	jalr	928(ra) # 5892 <close>
  for(int i = 0; i < 150; i++){
  ...
  exit(xstatus);
    ...
    1540:	32e080e7          	jalr	814(ra) # 586a <exit>
    ...
    155e:	310080e7          	jalr	784(ra) # 586a <exit>
...
0000000000001562 <exectest>:
{
  ...
  unlink("echo-ok");
    ...
    1598:	326080e7          	jalr	806(ra) # 58ba <unlink>
  pid = fork();
    159c:	00004097          	auipc	ra,0x4
    15a0:	2c6080e7          	jalr	710(ra) # 5862 <fork>
  if(pid < 0) {
  ...
  if(pid == 0) {
    ...
    15b2:	2e4080e7          	jalr	740(ra) # 5892 <close>
    ...
    15c6:	2e8080e7          	jalr	744(ra) # 58aa <open>
    if(fd < 0) {
    ...
    15ec:	282080e7          	jalr	642(ra) # 586a <exit>
     printf("%s: fork failed\n", s);
    15f0:	85ca                	mv	a1,s2
    ...
    1608:	266080e7          	jalr	614(ra) # 586a <exit>
    ...
    1624:	24a080e7          	jalr	586(ra) # 586a <exit>
  ...
  if(xstatus != 0)
    ...
    165a:	214080e7          	jalr	532(ra) # 586a <exit>
    ...
    1676:	1f8080e7          	jalr	504(ra) # 586a <exit>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    169c:	212080e7          	jalr	530(ra) # 58aa <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16ae:	1d8080e7          	jalr	472(ra) # 5882 <read>
    16b2:	4789                	li	a5,2
    ...
    16d0:	19e080e7          	jalr	414(ra) # 586a <exit>
    printf("%s: open failed\n", s);
    16d4:	85ca                	mv	a1,s2
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1730:	13e080e7          	jalr	318(ra) # 586a <exit>
    exit(0);
    1734:	4501                	li	a0,0
    1736:	00004097          	auipc	ra,0x4
    173a:	134080e7          	jalr	308(ra) # 586a <exit>
...
000000000000173e <pipe1>:
{
  ...
  if(pipe(fds) != 0){
    ...
    175e:	120080e7          	jalr	288(ra) # 587a <pipe>
    1762:	ed25                	bnez	a0,17da <pipe1+0x9c>
    1764:	84aa                	mv	s1,a0
  pid = fork();
    1766:	00004097          	auipc	ra,0x4
    176a:	0fc080e7          	jalr	252(ra) # 5862 <fork>
    176e:	8a2a                	mv	s4,a0
  if(pid == 0){
    ...
    177e:	118080e7          	jalr	280(ra) # 5892 <close>
    total = 0;
    1782:	8a26                	mv	s4,s1
    cc = 1;
    1784:	4985                	li	s3,1
    ...
    179c:	0ea080e7          	jalr	234(ra) # 5882 <read>
    ...
    17f2:	07c080e7          	jalr	124(ra) # 586a <exit>
    close(fds[0]);
    17f6:	fa842503          	lw	a0,-88(s0)
    17fa:	00004097          	auipc	ra,0x4
    17fe:	098080e7          	jalr	152(ra) # 5892 <close>
    for(n = 0; n < N; n++){
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1840:	04e080e7          	jalr	78(ra) # 588a <write>
    ...
    185c:	012080e7          	jalr	18(ra) # 586a <exit>
    ...
    1878:	ff6080e7          	jalr	-10(ra) # 586a <exit>
    ...
    1906:	f68080e7          	jalr	-152(ra) # 586a <exit>
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1926:	f40080e7          	jalr	-192(ra) # 5862 <fork>
    192a:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    193a:	f3c080e7          	jalr	-196(ra) # 5872 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    1978:	ef6080e7          	jalr	-266(ra) # 586a <exit>
    ...
    1994:	eda080e7          	jalr	-294(ra) # 586a <exit>
    ...
    19b0:	ebe080e7          	jalr	-322(ra) # 586a <exit>
      exit(i);
    19b4:	854a                	mv	a0,s2
    19b6:	00004097          	auipc	ra,0x4
    19ba:	eb4080e7          	jalr	-332(ra) # 586a <exit>
...
00000000000019be <twochildren>:
{
    ...
    19d4:	e92080e7          	jalr	-366(ra) # 5862 <fork>
    if(pid1 < 0){
    ...
    19e2:	e84080e7          	jalr	-380(ra) # 5862 <fork>
      if(pid2 < 0){
    ...
    19f2:	e84080e7          	jalr	-380(ra) # 5872 <wait>
        wait(0);
    19f6:	4501                	li	a0,0
    19f8:	00004097          	auipc	ra,0x4
    19fc:	e7a080e7          	jalr	-390(ra) # 5872 <wait>
  for(int i = 0; i < 1000; i++){
    ...
    1a28:	e46080e7          	jalr	-442(ra) # 586a <exit>
      exit(0);
    1a2c:	00004097          	auipc	ra,0x4
    1a30:	e3e080e7          	jalr	-450(ra) # 586a <exit>
        printf("%s: fork failed\n", s);
    1a34:	85ca                	mv	a1,s2
    ...
    1a4c:	e22080e7          	jalr	-478(ra) # 586a <exit>
        exit(0);
    1a50:	00004097          	auipc	ra,0x4
    1a54:	e1a080e7          	jalr	-486(ra) # 586a <exit>
...
0000000000001a58 <forkfork>:
{
    ...
    1a68:	dfe080e7          	jalr	-514(ra) # 5862 <fork>
    if(pid < 0){
    ...
    1a76:	df0080e7          	jalr	-528(ra) # 5862 <fork>
    if(pid < 0){
    ...
    1a88:	dee080e7          	jalr	-530(ra) # 5872 <wait>
    if(xstatus != 0) {
    ...
    1a9a:	ddc080e7          	jalr	-548(ra) # 5872 <wait>
    if(xstatus != 0) {
    ...
    1ac6:	da8080e7          	jalr	-600(ra) # 586a <exit>
{
    1aca:	0c800493          	li	s1,200
        int pid1 = fork();
    1ace:	00004097          	auipc	ra,0x4
    1ad2:	d94080e7          	jalr	-620(ra) # 5862 <fork>
        if(pid1 < 0){
    ...
    1ae2:	d94080e7          	jalr	-620(ra) # 5872 <wait>
      for(int j = 0; j < 200; j++){
    ...
    1af0:	d7e080e7          	jalr	-642(ra) # 586a <exit>
          exit(1);
    1af4:	4505                	li	a0,1
    1af6:	00004097          	auipc	ra,0x4
    1afa:	d74080e7          	jalr	-652(ra) # 586a <exit>
          exit(0);
    1afe:	00004097          	auipc	ra,0x4
    1b02:	d6c080e7          	jalr	-660(ra) # 586a <exit>
    ...
    1b1e:	d50080e7          	jalr	-688(ra) # 586a <exit>
...
0000000000001b22 <reparent2>:
{
    ...
    1b34:	d32080e7          	jalr	-718(ra) # 5862 <fork>
    if(pid1 < 0){
    ...
    1b44:	d32080e7          	jalr	-718(ra) # 5872 <wait>
  for(int i = 0; i < 800; i++){
  ...
  exit(0);
    ...
    1b52:	d1c080e7          	jalr	-740(ra) # 586a <exit>
      printf("fork failed\n");
    ...
    1b6c:	d02080e7          	jalr	-766(ra) # 586a <exit>
      fork();
    1b70:	00004097          	auipc	ra,0x4
    1b74:	cf2080e7          	jalr	-782(ra) # 5862 <fork>
      fork();
    1b78:	00004097          	auipc	ra,0x4
    1b7c:	cea080e7          	jalr	-790(ra) # 5862 <fork>
      exit(0);
    1b80:	4501                	li	a0,0
    1b82:	00004097          	auipc	ra,0x4
    1b86:	ce8080e7          	jalr	-792(ra) # 586a <exit>
...
0000000000001b8a <createdelete>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1bae:	cb8080e7          	jalr	-840(ra) # 5862 <fork>
    1bb2:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1bca:	cac080e7          	jalr	-852(ra) # 5872 <wait>
    if(xstatus != 0)
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c0a:	c64080e7          	jalr	-924(ra) # 586a <exit>
      name[0] = 'p' + pi;
    ...
    1c36:	c38080e7          	jalr	-968(ra) # 586a <exit>
      for(i = 0; i < N; i++){
    ...
    1c54:	c5a080e7          	jalr	-934(ra) # 58aa <open>
        if(fd < 0){
    1c58:	fc0543e3          	bltz	a0,1c1e <createdelete+0x94>
        close(fd);
    1c5c:	00004097          	auipc	ra,0x4
    1c60:	c36080e7          	jalr	-970(ra) # 5892 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1c88:	c36080e7          	jalr	-970(ra) # 58ba <unlink>
    ...
    1ca8:	bc6080e7          	jalr	-1082(ra) # 586a <exit>
      exit(0);
    1cac:	4501                	li	a0,0
    1cae:	00004097          	auipc	ra,0x4
    1cb2:	bbc080e7          	jalr	-1092(ra) # 586a <exit>
      exit(1);
    1cb6:	4505                	li	a0,1
    1cb8:	00004097          	auipc	ra,0x4
    1cbc:	bb2080e7          	jalr	-1102(ra) # 586a <exit>
    ...
    1cdc:	b92080e7          	jalr	-1134(ra) # 586a <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1d04:	baa080e7          	jalr	-1110(ra) # 58aa <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    1d1c:	b7a080e7          	jalr	-1158(ra) # 5892 <close>
    ...
    1d42:	b2c080e7          	jalr	-1236(ra) # 586a <exit>
  for(i = 0; i < N; i++){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1d7c:	b42080e7          	jalr	-1214(ra) # 58ba <unlink>
    for(pi = 0; pi < NCHILD; pi++){
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd8:	ae6080e7          	jalr	-1306(ra) # 58ba <unlink>
  pid = fork();
    1ddc:	00004097          	auipc	ra,0x4
    1de0:	a86080e7          	jalr	-1402(ra) # 5862 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e32:	a3c080e7          	jalr	-1476(ra) # 586a <exit>
      close(open("x", O_RDWR | O_CREATE));
    1e36:	20200593          	li	a1,514
    1e3a:	8556                	mv	a0,s5
    1e3c:	00004097          	auipc	ra,0x4
    1e40:	a6e080e7          	jalr	-1426(ra) # 58aa <open>
    1e44:	00004097          	auipc	ra,0x4
    1e48:	a4e080e7          	jalr	-1458(ra) # 5892 <close>
    1e4c:	a031                	j	1e58 <linkunlink+0xa8>
      unlink("x");
    1e4e:	8556                	mv	a0,s5
    1e50:	00004097          	auipc	ra,0x4
    1e54:	a6a080e7          	jalr	-1430(ra) # 58ba <unlink>
  for(i = 0; i < 100; i++){
    ...
    1e7a:	a54080e7          	jalr	-1452(ra) # 58ca <link>
  ...
  if(pid)
    ...
    1e8a:	9ec080e7          	jalr	-1556(ra) # 5872 <wait>
}
    ...
    1eae:	9c0080e7          	jalr	-1600(ra) # 586a <exit>
...
0000000000001eb2 <manywrites>:
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    1ed2:	994080e7          	jalr	-1644(ra) # 5862 <fork>
    1ed6:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    1ef2:	984080e7          	jalr	-1660(ra) # 5872 <wait>
    if(st != 0)
  ...
  exit(0);
    ...
    1f06:	968080e7          	jalr	-1688(ra) # 586a <exit>
      printf("fork failed\n");
    ...
    1f20:	94e080e7          	jalr	-1714(ra) # 586a <exit>
      name[0] = 'b';
    ...
    1f40:	97e080e7          	jalr	-1666(ra) # 58ba <unlink>
    1f44:	4b79                	li	s6,30
          int cc = write(fd, buf, sz);
    ...
    1f60:	94e080e7          	jalr	-1714(ra) # 58aa <open>
    1f64:	89aa                	mv	s3,a0
          if(fd < 0){
    ...
    1f72:	91c080e7          	jalr	-1764(ra) # 588a <write>
          if(cc != sz){
    ...
    1f82:	914080e7          	jalr	-1772(ra) # 5892 <close>
        for(int i = 0; i < ci+1; i++){
    ...
    1f94:	92a080e7          	jalr	-1750(ra) # 58ba <unlink>
    ...
    1fa6:	918080e7          	jalr	-1768(ra) # 58ba <unlink>
      exit(0);
    1faa:	4501                	li	a0,0
    1fac:	00004097          	auipc	ra,0x4
    1fb0:	8be080e7          	jalr	-1858(ra) # 586a <exit>
    ...
    1fd0:	89e080e7          	jalr	-1890(ra) # 586a <exit>
            printf("%s: write(%d) ret %d\n", s, sz, cc);
    1fd4:	86aa                	mv	a3,a0
    ...
    1ff0:	87e080e7          	jalr	-1922(ra) # 586a <exit>
      exit(st);
    1ff4:	00004097          	auipc	ra,0x4
    1ff8:	876080e7          	jalr	-1930(ra) # 586a <exit>
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2016:	850080e7          	jalr	-1968(ra) # 5862 <fork>
    if(pid < 0)
  ...
  for(n=0; n<N; n++){
    ...
    203e:	830080e7          	jalr	-2000(ra) # 586a <exit>
      exit(0);
    2042:	00004097          	auipc	ra,0x4
    2046:	828080e7          	jalr	-2008(ra) # 586a <exit>
  if (n == 0) {
  ...
  for(; n > 0; n--){
    ...
    205e:	818080e7          	jalr	-2024(ra) # 5872 <wait>
  ...
  if(wait(0) != -1){
    ...
    2070:	806080e7          	jalr	-2042(ra) # 5872 <wait>
    2074:	57fd                	li	a5,-1
    ...
    20a0:	7ce080e7          	jalr	1998(ra) # 586a <exit>
    ...
    20bc:	7b2080e7          	jalr	1970(ra) # 586a <exit>
    ...
    20d8:	796080e7          	jalr	1942(ra) # 586a <exit>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    210a:	75c080e7          	jalr	1884(ra) # 5862 <fork>
    if(pid < 0){
    ...
    211c:	75a080e7          	jalr	1882(ra) # 5872 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2158:	716080e7          	jalr	1814(ra) # 586a <exit>
    ...
    217a:	6f4080e7          	jalr	1780(ra) # 586a <exit>
      exit(1);
    217e:	4505                	li	a0,1
    2180:	00003097          	auipc	ra,0x3
    2184:	6ea080e7          	jalr	1770(ra) # 586a <exit>
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21aa:	6bc080e7          	jalr	1724(ra) # 5862 <fork>
    if(pid < 0){
    ...
    21bc:	6ba080e7          	jalr	1722(ra) # 5872 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for( ; a != 0; a <<= 1){
    ...
    21fc:	672080e7          	jalr	1650(ra) # 586a <exit>
      *(char*)a = 99;
    ...
    2228:	646080e7          	jalr	1606(ra) # 586a <exit>
      exit(1);
    222c:	4505                	li	a0,1
    222e:	00003097          	auipc	ra,0x3
    2232:	63c080e7          	jalr	1596(ra) # 586a <exit>
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    224e:	670080e7          	jalr	1648(ra) # 58ba <unlink>
  pid = fork();
    2252:	00003097          	auipc	ra,0x3
    2256:	610080e7          	jalr	1552(ra) # 5862 <fork>
  if(pid == 0){
  ...
  wait(&xstatus);
    ...
    2268:	60e080e7          	jalr	1550(ra) # 5872 <wait>
  if(xstatus != 0)
  ...
  fd = open("bigarg-ok", 0);
    ...
    2280:	62e080e7          	jalr	1582(ra) # 58aa <open>
  if(fd < 0){
    2284:	08054e63          	bltz	a0,2320 <bigargtest+0xea>
  close(fd);
    2288:	00003097          	auipc	ra,0x3
    228c:	60a080e7          	jalr	1546(ra) # 5892 <close>
}
    ...
    229e:	2f678793          	addi	a5,a5,758 # 8590 <args.1859>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3e668693          	addi	a3,a3,998 # 8688 <args.1859+0xf8>
    ...
    22be:	2d658593          	addi	a1,a1,726 # 8590 <args.1859>
    ...
    22d2:	5d4080e7          	jalr	1492(ra) # 58a2 <exec>
    ...
    22e6:	5c8080e7          	jalr	1480(ra) # 58aa <open>
    close(fd);
    22ea:	00003097          	auipc	ra,0x3
    22ee:	5a8080e7          	jalr	1448(ra) # 5892 <close>
    exit(0);
    22f2:	4501                	li	a0,0
    22f4:	00003097          	auipc	ra,0x3
    22f8:	576080e7          	jalr	1398(ra) # 586a <exit>
    ...
    2314:	55a080e7          	jalr	1370(ra) # 586a <exit>
    exit(xstatus);
    2318:	00003097          	auipc	ra,0x3
    231c:	552080e7          	jalr	1362(ra) # 586a <exit>
    ...
    2338:	536080e7          	jalr	1334(ra) # 586a <exit>
...
000000000000233c <stacktest>:
{
  ...
  pid = fork();
    ...
    234c:	51a080e7          	jalr	1306(ra) # 5862 <fork>
  if(pid == 0) {
  ...
  wait(&xstatus);
    ...
    235e:	518080e7          	jalr	1304(ra) # 5872 <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    2370:	4fe080e7          	jalr	1278(ra) # 586a <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2396:	4d8080e7          	jalr	1240(ra) # 586a <exit>
    printf("%s: fork failed\n", s);
    239a:	85a6                	mv	a1,s1
    ...
    23b2:	4bc080e7          	jalr	1212(ra) # 586a <exit>
    exit(0);
    23b6:	4501                	li	a0,0
    23b8:	00003097          	auipc	ra,0x3
    23bc:	4b2080e7          	jalr	1202(ra) # 586a <exit>
...
00000000000023c0 <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    23d0:	526080e7          	jalr	1318(ra) # 58f2 <sbrk>
  uint64 top = (uint64) sbrk(0);
    23d4:	4501                	li	a0,0
    23d6:	00003097          	auipc	ra,0x3
    23da:	51c080e7          	jalr	1308(ra) # 58f2 <sbrk>
  if((top % PGSIZE) != 0){
  ...
  top = (uint64) sbrk(0);
    ...
    23ea:	50c080e7          	jalr	1292(ra) # 58f2 <sbrk>
  if(top % PGSIZE){
  ...
  *b = 'x';
  ...
  int ret = unlink(b);
    ...
    2406:	4b8080e7          	jalr	1208(ra) # 58ba <unlink>
  if(ret != -1){
    240a:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    241a:	494080e7          	jalr	1172(ra) # 58aa <open>
  if(fd != -1){
    241e:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    242c:	4a2080e7          	jalr	1186(ra) # 58ca <link>
  if(ret != -1){
    2430:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    2450:	456080e7          	jalr	1110(ra) # 58a2 <exec>
  if(ret != -1){
    2454:	57fd                	li	a5,-1
    ...
    2472:	484080e7          	jalr	1156(ra) # 58f2 <sbrk>
    ...
    248e:	3e0080e7          	jalr	992(ra) # 586a <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    2492:	862a                	mv	a2,a0
    2494:	85a6                	mv	a1,s1
    ...
    24ac:	3c2080e7          	jalr	962(ra) # 586a <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    24b0:	862a                	mv	a2,a0
    24b2:	85a6                	mv	a1,s1
    ...
    24ca:	3a4080e7          	jalr	932(ra) # 586a <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    24ce:	86aa                	mv	a3,a0
    24d0:	8626                	mv	a2,s1
    24d2:	85a6                	mv	a1,s1
    ...
    24ea:	384080e7          	jalr	900(ra) # 586a <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    24ee:	567d                	li	a2,-1
    24f0:	85a6                	mv	a1,s1
    ...
    2508:	366080e7          	jalr	870(ra) # 586a <exit>
...
000000000000250c <rwsbrk>:
{
  ...
  uint64 a = (uint64) sbrk(8192);
    ...
    251e:	3d8080e7          	jalr	984(ra) # 58f2 <sbrk>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    2530:	3c6080e7          	jalr	966(ra) # 58f2 <sbrk>
    2534:	57fd                	li	a5,-1
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    254a:	364080e7          	jalr	868(ra) # 58aa <open>
    254e:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  n = write(fd, (void*)(a+4096), 1024);
    ...
    2564:	32a080e7          	jalr	810(ra) # 588a <write>
    2568:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    2586:	2e8080e7          	jalr	744(ra) # 586a <exit>
    ...
    25a0:	2ce080e7          	jalr	718(ra) # 586a <exit>
    ...
    25ba:	2b4080e7          	jalr	692(ra) # 586a <exit>
  ...
  n = read(fd, (void*)(a+4096), 10);
    ...
    2612:	274080e7          	jalr	628(ra) # 5882 <read>
    2616:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    2634:	23a080e7          	jalr	570(ra) # 586a <exit>
    printf("open(rwsbrk) failed\n");
    ...
    264e:	220080e7          	jalr	544(ra) # 586a <exit>
  close(fd);
    2652:	854a                	mv	a0,s2
    2654:	00003097          	auipc	ra,0x3
    2658:	23e080e7          	jalr	574(ra) # 5892 <close>
  exit(0);
    265c:	4501                	li	a0,0
    265e:	00003097          	auipc	ra,0x3
    2662:	20c080e7          	jalr	524(ra) # 586a <exit>
...
0000000000002666 <sbrkbasic>:
{
  ...
  pid = fork();
    ...
    267e:	1e8080e7          	jalr	488(ra) # 5862 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2690:	266080e7          	jalr	614(ra) # 58f2 <sbrk>
    ...
    26b6:	1b8080e7          	jalr	440(ra) # 586a <exit>
    ...
    26d0:	19e080e7          	jalr	414(ra) # 586a <exit>
      exit(0);
    26d4:	4501                	li	a0,0
    26d6:	00003097          	auipc	ra,0x3
    26da:	194080e7          	jalr	404(ra) # 586a <exit>
  wait(&xstatus);
    26de:	fbc40513          	addi	a0,s0,-68
    26e2:	00003097          	auipc	ra,0x3
    26e6:	190080e7          	jalr	400(ra) # 5872 <wait>
  if(xstatus == 1){
  ...
  a = sbrk(0);
    ...
    26fa:	1fc080e7          	jalr	508(ra) # 58f2 <sbrk>
    26fe:	84aa                	mv	s1,a0
  for(i = 0; i < 5000; i++){
    2700:	4901                	li	s2,0
    *b = 1;
  ...
  for(i = 0; i < 5000; i++){
    ...
    2724:	14a080e7          	jalr	330(ra) # 586a <exit>
    a = b + 1;
    2728:	84be                	mv	s1,a5
    b = sbrk(1);
    272a:	4505                	li	a0,1
    272c:	00003097          	auipc	ra,0x3
    2730:	1c6080e7          	jalr	454(ra) # 58f2 <sbrk>
    if(b != a){
  ...
  pid = fork();
    ...
    274a:	11c080e7          	jalr	284(ra) # 5862 <fork>
    274e:	892a                	mv	s2,a0
  if(pid < 0){
  ...
  c = sbrk(1);
    ...
    275a:	19c080e7          	jalr	412(ra) # 58f2 <sbrk>
  c = sbrk(1);
    275e:	4505                	li	a0,1
    2760:	00003097          	auipc	ra,0x3
    2764:	192080e7          	jalr	402(ra) # 58f2 <sbrk>
  if(c != a + 1){
    ...
    2786:	0e8080e7          	jalr	232(ra) # 586a <exit>
    ...
    27a8:	0c6080e7          	jalr	198(ra) # 586a <exit>
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    285a:	09c080e7          	jalr	156(ra) # 58f2 <sbrk>
    285e:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2860:	757d                	lui	a0,0xfffff
    2862:	00003097          	auipc	ra,0x3
    2866:	090080e7          	jalr	144(ra) # 58f2 <sbrk>
  ...
  c = sbrk(0);
    ...
    2876:	080080e7          	jalr	128(ra) # 58f2 <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    ...
    28c6:	030080e7          	jalr	48(ra) # 58f2 <sbrk>
    28ca:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    28cc:	4501                	li	a0,0
    28ce:	00003097          	auipc	ra,0x3
    28d2:	024080e7          	jalr	36(ra) # 58f2 <sbrk>
  ...
  if(c != a){
    ...
    290e:	f60080e7          	jalr	-160(ra) # 586a <exit>
    ...
    292a:	f44080e7          	jalr	-188(ra) # 586a <exit>
    ...
    294a:	f24080e7          	jalr	-220(ra) # 586a <exit>
    ...
    296a:	f04080e7          	jalr	-252(ra) # 586a <exit>
    ...
    2986:	ee8080e7          	jalr	-280(ra) # 586a <exit>
    ...
    29a6:	ec8080e7          	jalr	-312(ra) # 586a <exit>
...
00000000000029aa <sbrkarg>:
{
  ...
  a = sbrk(PGSIZE);
    ...
    29c0:	f36080e7          	jalr	-202(ra) # 58f2 <sbrk>
    29c4:	892a                	mv	s2,a0
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    29fa:	e94080e7          	jalr	-364(ra) # 588a <write>
    29fe:	04054663          	bltz	a0,2a4a <sbrkarg+0xa0>
  close(fd);
    2a02:	8526                	mv	a0,s1
    2a04:	00003097          	auipc	ra,0x3
    2a08:	e8e080e7          	jalr	-370(ra) # 5892 <close>
  a = sbrk(PGSIZE);
    2a0c:	6505                	lui	a0,0x1
    2a0e:	00003097          	auipc	ra,0x3
    2a12:	ee4080e7          	jalr	-284(ra) # 58f2 <sbrk>
  if(pipe((int *) a) != 0){
    2a16:	00003097          	auipc	ra,0x3
    2a1a:	e64080e7          	jalr	-412(ra) # 587a <pipe>
    ...
    2a46:	e28080e7          	jalr	-472(ra) # 586a <exit>
    ...
    2a62:	e0c080e7          	jalr	-500(ra) # 586a <exit>
    printf("%s: pipe() failed\n", s);
    2a66:	85ce                	mv	a1,s3
    ...
    2a7e:	df0080e7          	jalr	-528(ra) # 586a <exit>
...
0000000000002a82 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a9e:	e10080e7          	jalr	-496(ra) # 58aa <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    2aae:	e48080e7          	jalr	-440(ra) # 58f2 <sbrk>
    2ab2:	567d                	li	a2,-1
    2ab4:	fff50593          	addi	a1,a0,-1
    2ab8:	8526                	mv	a0,s1
    2aba:	00003097          	auipc	ra,0x3
    2abe:	dc8080e7          	jalr	-568(ra) # 5882 <read>
  close(fd);
    2ac2:	8526                	mv	a0,s1
    2ac4:	00003097          	auipc	ra,0x3
    2ac8:	dce080e7          	jalr	-562(ra) # 5892 <close>
}
    ...
    2af0:	d7e080e7          	jalr	-642(ra) # 586a <exit>
...
0000000000002af4 <sbrkbugs>:
{
  ...
  int pid = fork();
    ...
    2b00:	d66080e7          	jalr	-666(ra) # 5862 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2b0e:	de8080e7          	jalr	-536(ra) # 58f2 <sbrk>
    sbrk(-sz);
    2b12:	40a0053b          	negw	a0,a0
    2b16:	00003097          	auipc	ra,0x3
    2b1a:	ddc080e7          	jalr	-548(ra) # 58f2 <sbrk>
    exit(0);
    2b1e:	4501                	li	a0,0
    2b20:	00003097          	auipc	ra,0x3
    2b24:	d4a080e7          	jalr	-694(ra) # 586a <exit>
    printf("fork failed\n");
    ...
    2b3e:	d30080e7          	jalr	-720(ra) # 586a <exit>
  wait(0);
    2b42:	4501                	li	a0,0
    2b44:	00003097          	auipc	ra,0x3
    2b48:	d2e080e7          	jalr	-722(ra) # 5872 <wait>
  pid = fork();
    2b4c:	00003097          	auipc	ra,0x3
    2b50:	d16080e7          	jalr	-746(ra) # 5862 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2b94:	cda080e7          	jalr	-806(ra) # 586a <exit>
  wait(0);
    2b98:	4501                	li	a0,0
    2b9a:	00003097          	auipc	ra,0x3
    2b9e:	cd8080e7          	jalr	-808(ra) # 5872 <wait>
  pid = fork();
    2ba2:	00003097          	auipc	ra,0x3
    2ba6:	cc0080e7          	jalr	-832(ra) # 5862 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2bf4:	c7a080e7          	jalr	-902(ra) # 586a <exit>
  wait(0);
    2bf8:	4501                	li	a0,0
    2bfa:	00003097          	auipc	ra,0x3
    2bfe:	c78080e7          	jalr	-904(ra) # 5872 <wait>
  exit(0);
    2c02:	4501                	li	a0,0
    2c04:	00003097          	auipc	ra,0x3
    2c08:	c66080e7          	jalr	-922(ra) # 586a <exit>
...
0000000000002c0c <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    ...
    2c20:	cd6080e7          	jalr	-810(ra) # 58f2 <sbrk>
  if((top % 4096) != 0)
  ...
  sbrk(4096);
    ...
    2c30:	cc6080e7          	jalr	-826(ra) # 58f2 <sbrk>
  sbrk(10);
    2c34:	4529                	li	a0,10
    2c36:	00003097          	auipc	ra,0x3
    2c3a:	cbc080e7          	jalr	-836(ra) # 58f2 <sbrk>
  sbrk(-20);
    2c3e:	5531                	li	a0,-20
    2c40:	00003097          	auipc	ra,0x3
    2c44:	cb2080e7          	jalr	-846(ra) # 58f2 <sbrk>
  top = (uint64) sbrk(0);
    2c48:	4501                	li	a0,0
    2c4a:	00003097          	auipc	ra,0x3
    2c4e:	ca8080e7          	jalr	-856(ra) # 58f2 <sbrk>
    2c52:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2c6e:	c40080e7          	jalr	-960(ra) # 58aa <open>
    2c72:	89aa                	mv	s3,a0
  write(fd, p, 1);
    2c74:	4605                	li	a2,1
    2c76:	85ca                	mv	a1,s2
    2c78:	00003097          	auipc	ra,0x3
    2c7c:	c12080e7          	jalr	-1006(ra) # 588a <write>
  close(fd);
    2c80:	854e                	mv	a0,s3
    2c82:	00003097          	auipc	ra,0x3
    2c86:	c10080e7          	jalr	-1008(ra) # 5892 <close>
  fd = open(p, O_RDWR);
    2c8a:	4589                	li	a1,2
    2c8c:	854a                	mv	a0,s2
    2c8e:	00003097          	auipc	ra,0x3
    2c92:	c1c080e7          	jalr	-996(ra) # 58aa <open>
  p[0] = '\0';
  ...
  read(fd, p, 1);
    ...
    2ca2:	be4080e7          	jalr	-1052(ra) # 5882 <read>
  if(p[0] != 'x')
    ...
    2cce:	c28080e7          	jalr	-984(ra) # 58f2 <sbrk>
    2cd2:	bfa1                	j	2c2a <sbrklast+0x1e>
    exit(1);
    2cd4:	4505                	li	a0,1
    2cd6:	00003097          	auipc	ra,0x3
    2cda:	b94080e7          	jalr	-1132(ra) # 586a <exit>
...
0000000000002cde <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2cf0:	c06080e7          	jalr	-1018(ra) # 58f2 <sbrk>
  volatile char *top = sbrk(0);
    2cf4:	4501                	li	a0,0
    2cf6:	00003097          	auipc	ra,0x3
    2cfa:	bfc080e7          	jalr	-1028(ra) # 58f2 <sbrk>
  *(top-1) = *(top-1) + 1;
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    2d2c:	b3a080e7          	jalr	-1222(ra) # 5862 <fork>
    2d30:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    2d3e:	b38080e7          	jalr	-1224(ra) # 5872 <wait>
  for(int avail = 0; avail < 15; avail++){
  ...
  exit(0);
    ...
    2d4e:	b20080e7          	jalr	-1248(ra) # 586a <exit>
      printf("fork failed\n");
    ...
    2d68:	b06080e7          	jalr	-1274(ra) # 586a <exit>
        if(a == 0xffffffffffffffffLL)
    2d6c:	59fd                	li	s3,-1
        *(char*)(a + 4096 - 1) = 1;
    2d6e:	4a05                	li	s4,1
    ...
    2d76:	b80080e7          	jalr	-1152(ra) # 58f2 <sbrk>
        if(a == 0xffffffffffffffffLL)
    ...
    2d92:	b64080e7          	jalr	-1180(ra) # 58f2 <sbrk>
      for(int i = 0; i < avail; i++)
    ...
    2da2:	af4080e7          	jalr	-1292(ra) # 5892 <close>
      char *args[] = { "echo", "x", 0 };
    ...
    2dca:	adc080e7          	jalr	-1316(ra) # 58a2 <exec>
      exit(0);
    2dce:	4501                	li	a0,0
    2dd0:	00003097          	auipc	ra,0x3
    2dd4:	a9a080e7          	jalr	-1382(ra) # 586a <exit>
...
0000000000002dd8 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2df0:	ae6080e7          	jalr	-1306(ra) # 58d2 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2e02:	ad4080e7          	jalr	-1324(ra) # 58d2 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e64:	a72080e7          	jalr	-1422(ra) # 58d2 <mkdir>
  ...
  unlink("12345678901234");
    ...
    2eec:	982080e7          	jalr	-1662(ra) # 586a <exit>
    ...
    2f08:	966080e7          	jalr	-1690(ra) # 586a <exit>
    ...
    2f24:	94a080e7          	jalr	-1718(ra) # 586a <exit>
    ...
    2f40:	92e080e7          	jalr	-1746(ra) # 586a <exit>
    ...
    2f5c:	912080e7          	jalr	-1774(ra) # 586a <exit>
    ...
    2f78:	8f6080e7          	jalr	-1802(ra) # 586a <exit>
...
0000000000002f7c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f94:	942080e7          	jalr	-1726(ra) # 58d2 <mkdir>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa8:	936080e7          	jalr	-1738(ra) # 58da <chdir>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fbc:	902080e7          	jalr	-1790(ra) # 58ba <unlink>
  ...
  if(chdir("/") < 0){
    ...
    2fd0:	90e080e7          	jalr	-1778(ra) # 58da <chdir>
    ...
    2ffa:	874080e7          	jalr	-1932(ra) # 586a <exit>
    ...
    3016:	858080e7          	jalr	-1960(ra) # 586a <exit>
    ...
    3032:	83c080e7          	jalr	-1988(ra) # 586a <exit>
    ...
    304e:	820080e7          	jalr	-2016(ra) # 586a <exit>
...
0000000000003052 <exitiputtest>:
{
  ...
  pid = fork();
    ...
    3062:	804080e7          	jalr	-2044(ra) # 5862 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3078:	85e080e7          	jalr	-1954(ra) # 58d2 <mkdir>
    ...
    308c:	852080e7          	jalr	-1966(ra) # 58da <chdir>
    ...
    30a0:	81e080e7          	jalr	-2018(ra) # 58ba <unlink>
    30a4:	06054163          	bltz	a0,3106 <exitiputtest+0xb4>
    exit(0);
    30a8:	4501                	li	a0,0
    30aa:	00002097          	auipc	ra,0x2
    30ae:	7c0080e7          	jalr	1984(ra) # 586a <exit>
    printf("%s: fork failed\n", s);
    30b2:	85a6                	mv	a1,s1
    ...
    30ca:	7a4080e7          	jalr	1956(ra) # 586a <exit>
      printf("%s: mkdir failed\n", s);
    30ce:	85a6                	mv	a1,s1
    ...
    30e6:	788080e7          	jalr	1928(ra) # 586a <exit>
    ...
    3102:	76c080e7          	jalr	1900(ra) # 586a <exit>
      printf("%s: unlink ../iputdir failed\n", s);
    3106:	85a6                	mv	a1,s1
    ...
    311e:	750080e7          	jalr	1872(ra) # 586a <exit>
  wait(&xstatus);
    3122:	fdc40513          	addi	a0,s0,-36
    3126:	00002097          	auipc	ra,0x2
    312a:	74c080e7          	jalr	1868(ra) # 5872 <wait>
  exit(xstatus);
...
000000000000313a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3152:	784080e7          	jalr	1924(ra) # 58d2 <mkdir>
  ...
  if(chdir("dir0") < 0){
    ...
    3166:	778080e7          	jalr	1912(ra) # 58da <chdir>
  ...
  if(chdir("..") < 0){
    ...
    317a:	764080e7          	jalr	1892(ra) # 58da <chdir>
  ...
  if(unlink("dir0") < 0){
    ...
    318e:	730080e7          	jalr	1840(ra) # 58ba <unlink>
    ...
    31b8:	6b6080e7          	jalr	1718(ra) # 586a <exit>
    ...
    31d4:	69a080e7          	jalr	1690(ra) # 586a <exit>
    printf("%s: chdir .. failed\n", s);
    31d8:	85a6                	mv	a1,s1
    ...
    31f0:	67e080e7          	jalr	1662(ra) # 586a <exit>
    ...
    320c:	662080e7          	jalr	1634(ra) # 586a <exit>
...
0000000000003210 <subdir>:
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3252:	65c080e7          	jalr	1628(ra) # 58aa <open>
    3256:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3298:	63e080e7          	jalr	1598(ra) # 58d2 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32b0:	5fe080e7          	jalr	1534(ra) # 58aa <open>
    32b4:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32fc:	58a080e7          	jalr	1418(ra) # 5882 <read>
  if(cc != 2 || buf[0] != 'f'){
    3300:	4789                	li	a5,2
  ...
  close(fd);
    ...
    331c:	57a080e7          	jalr	1402(ra) # 5892 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3334:	59a080e7          	jalr	1434(ra) # 58ca <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3348:	576080e7          	jalr	1398(ra) # 58ba <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    335e:	550080e7          	jalr	1360(ra) # 58aa <open>
  ...
  if(chdir("dd") != 0){
    ...
    3372:	56c080e7          	jalr	1388(ra) # 58da <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3386:	558080e7          	jalr	1368(ra) # 58da <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    339a:	544080e7          	jalr	1348(ra) # 58da <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    33ae:	530080e7          	jalr	1328(ra) # 58da <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33c4:	4ea080e7          	jalr	1258(ra) # 58aa <open>
    33c8:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    345c:	452080e7          	jalr	1106(ra) # 58aa <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3472:	43c080e7          	jalr	1084(ra) # 58aa <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    348e:	440080e7          	jalr	1088(ra) # 58ca <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    34aa:	424080e7          	jalr	1060(ra) # 58ca <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34c6:	408080e7          	jalr	1032(ra) # 58ca <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34da:	3fc080e7          	jalr	1020(ra) # 58d2 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34ee:	3e8080e7          	jalr	1000(ra) # 58d2 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3502:	3d4080e7          	jalr	980(ra) # 58d2 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3516:	3a8080e7          	jalr	936(ra) # 58ba <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    352a:	394080e7          	jalr	916(ra) # 58ba <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    353e:	3a0080e7          	jalr	928(ra) # 58da <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3552:	38c080e7          	jalr	908(ra) # 58da <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3566:	358080e7          	jalr	856(ra) # 58ba <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    357a:	344080e7          	jalr	836(ra) # 58ba <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    358e:	330080e7          	jalr	816(ra) # 58ba <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    35a2:	31c080e7          	jalr	796(ra) # 58ba <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    35b6:	308080e7          	jalr	776(ra) # 58ba <unlink>
    ...
    35e2:	28c080e7          	jalr	652(ra) # 586a <exit>
    ...
    35fe:	270080e7          	jalr	624(ra) # 586a <exit>
    ...
    361a:	254080e7          	jalr	596(ra) # 586a <exit>
    ...
    3636:	238080e7          	jalr	568(ra) # 586a <exit>
    ...
    3652:	21c080e7          	jalr	540(ra) # 586a <exit>
    ...
    366e:	200080e7          	jalr	512(ra) # 586a <exit>
    ...
    368a:	1e4080e7          	jalr	484(ra) # 586a <exit>
    ...
    36a6:	1c8080e7          	jalr	456(ra) # 586a <exit>
    ...
    36c2:	1ac080e7          	jalr	428(ra) # 586a <exit>
    ...
    36de:	190080e7          	jalr	400(ra) # 586a <exit>
    ...
    36fa:	174080e7          	jalr	372(ra) # 586a <exit>
    ...
    3716:	158080e7          	jalr	344(ra) # 586a <exit>
    ...
    3732:	13c080e7          	jalr	316(ra) # 586a <exit>
    printf("%s: chdir ./.. failed\n", s);
    3736:	85ca                	mv	a1,s2
    ...
    374e:	120080e7          	jalr	288(ra) # 586a <exit>
    ...
    376a:	104080e7          	jalr	260(ra) # 586a <exit>
    ...
    3786:	0e8080e7          	jalr	232(ra) # 586a <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded!\n", s);
    378a:	85ca                	mv	a1,s2
    ...
    37a2:	0cc080e7          	jalr	204(ra) # 586a <exit>
    ...
    37be:	0b0080e7          	jalr	176(ra) # 586a <exit>
    ...
    37da:	094080e7          	jalr	148(ra) # 586a <exit>
    ...
    37f6:	078080e7          	jalr	120(ra) # 586a <exit>
    ...
    3812:	05c080e7          	jalr	92(ra) # 586a <exit>
    ...
    382e:	040080e7          	jalr	64(ra) # 586a <exit>
    ...
    384a:	024080e7          	jalr	36(ra) # 586a <exit>
    ...
    3866:	008080e7          	jalr	8(ra) # 586a <exit>
    ...
    3882:	fec080e7          	jalr	-20(ra) # 586a <exit>
    ...
    389e:	fd0080e7          	jalr	-48(ra) # 586a <exit>
    ...
    38ba:	fb4080e7          	jalr	-76(ra) # 586a <exit>
    ...
    38d6:	f98080e7          	jalr	-104(ra) # 586a <exit>
    ...
    38f2:	f7c080e7          	jalr	-132(ra) # 586a <exit>
    ...
    390e:	f60080e7          	jalr	-160(ra) # 586a <exit>
    ...
    392a:	f44080e7          	jalr	-188(ra) # 586a <exit>
    ...
    3946:	f28080e7          	jalr	-216(ra) # 586a <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    394a:	85ca                	mv	a1,s2
    ...
    3962:	f0c080e7          	jalr	-244(ra) # 586a <exit>
    ...
    397e:	ef0080e7          	jalr	-272(ra) # 586a <exit>
    ...
    399a:	ed4080e7          	jalr	-300(ra) # 586a <exit>
    ...
    39b6:	eb8080e7          	jalr	-328(ra) # 586a <exit>
    ...
    39d2:	e9c080e7          	jalr	-356(ra) # 586a <exit>
...
00000000000039d6 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39ee:	ee8080e7          	jalr	-280(ra) # 58d2 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    3a00:	ede080e7          	jalr	-290(ra) # 58da <chdir>
  ...
  if(unlink(".") == 0){
    ...
    3a12:	eac080e7          	jalr	-340(ra) # 58ba <unlink>
  ...
  if(unlink("..") == 0){
    ...
    3a24:	e9a080e7          	jalr	-358(ra) # 58ba <unlink>
  ...
  if(chdir("/") != 0){
    ...
    3a36:	ea8080e7          	jalr	-344(ra) # 58da <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a48:	e76080e7          	jalr	-394(ra) # 58ba <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a5a:	e64080e7          	jalr	-412(ra) # 58ba <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    3a6c:	e52080e7          	jalr	-430(ra) # 58ba <unlink>
    ...
    3a94:	dda080e7          	jalr	-550(ra) # 586a <exit>
    ...
    3ab0:	dbe080e7          	jalr	-578(ra) # 586a <exit>
    printf("%s: rm . worked!\n", s);
    3ab4:	85a6                	mv	a1,s1
    ...
    3acc:	da2080e7          	jalr	-606(ra) # 586a <exit>
    printf("%s: rm .. worked!\n", s);
    3ad0:	85a6                	mv	a1,s1
    ...
    3ae8:	d86080e7          	jalr	-634(ra) # 586a <exit>
    printf("%s: chdir / failed\n", s);
    3aec:	85a6                	mv	a1,s1
    ...
    3b04:	d6a080e7          	jalr	-662(ra) # 586a <exit>
    ...
    3b20:	d4e080e7          	jalr	-690(ra) # 586a <exit>
    printf("%s: unlink dots/.. worked!\n", s);
    3b24:	85a6                	mv	a1,s1
    ...
    3b3c:	d32080e7          	jalr	-718(ra) # 586a <exit>
    ...
    3b58:	d16080e7          	jalr	-746(ra) # 586a <exit>
...
0000000000003b5c <dirfile>:
{
  ...
  fd = open("dirfile/xx", 0);
    ...
    3baa:	d04080e7          	jalr	-764(ra) # 58aa <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bd6:	d00080e7          	jalr	-768(ra) # 58d2 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bea:	cd4080e7          	jalr	-812(ra) # 58ba <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3c06:	cc8080e7          	jalr	-824(ra) # 58ca <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c1a:	ca4080e7          	jalr	-860(ra) # 58ba <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    3c30:	c7e080e7          	jalr	-898(ra) # 58aa <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    3c46:	c68080e7          	jalr	-920(ra) # 58aa <open>
    3c4a:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    3c4c:	4605                	li	a2,1
    ...
    3c5a:	c34080e7          	jalr	-972(ra) # 588a <write>
    3c5e:	10a04b63          	bgtz	a0,3d74 <dirfile+0x218>
  close(fd);
    3c62:	8526                	mv	a0,s1
    3c64:	00002097          	auipc	ra,0x2
    3c68:	c2e080e7          	jalr	-978(ra) # 5892 <close>
}
    ...
    3c90:	bde080e7          	jalr	-1058(ra) # 586a <exit>
    ...
    3cac:	bc2080e7          	jalr	-1086(ra) # 586a <exit>
    ...
    3cc8:	ba6080e7          	jalr	-1114(ra) # 586a <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    3ccc:	85ca                	mv	a1,s2
    ...
    3ce4:	b8a080e7          	jalr	-1142(ra) # 586a <exit>
    ...
    3d00:	b6e080e7          	jalr	-1170(ra) # 586a <exit>
    ...
    3d1c:	b52080e7          	jalr	-1198(ra) # 586a <exit>
    ...
    3d38:	b36080e7          	jalr	-1226(ra) # 586a <exit>
    ...
    3d54:	b1a080e7          	jalr	-1254(ra) # 586a <exit>
    ...
    3d70:	afe080e7          	jalr	-1282(ra) # 586a <exit>
    ...
    3d8c:	ae2080e7          	jalr	-1310(ra) # 586a <exit>
...
0000000000003d90 <iref>:
{
    ...
    3de4:	a8a080e7          	jalr	-1398(ra) # 586a <exit>
    ...
    3e00:	a6e080e7          	jalr	-1426(ra) # 586a <exit>
      close(fd);
    3e04:	00002097          	auipc	ra,0x2
    3e08:	a8e080e7          	jalr	-1394(ra) # 5892 <close>
    3e0c:	a889                	j	3e5e <iref+0xce>
    unlink("xx");
    3e0e:	854e                	mv	a0,s3
    3e10:	00002097          	auipc	ra,0x2
    3e14:	aaa080e7          	jalr	-1366(ra) # 58ba <unlink>
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e24:	ab2080e7          	jalr	-1358(ra) # 58d2 <mkdir>
    3e28:	f155                	bnez	a0,3dcc <iref+0x3c>
    if(chdir("irefd") != 0){
    3e2a:	8552                	mv	a0,s4
    3e2c:	00002097          	auipc	ra,0x2
    3e30:	aae080e7          	jalr	-1362(ra) # 58da <chdir>
    ...
    3e48:	a86080e7          	jalr	-1402(ra) # 58ca <link>
    fd = open("", O_CREATE);
    3e4c:	20000593          	li	a1,512
    3e50:	8526                	mv	a0,s1
    3e52:	00002097          	auipc	ra,0x2
    3e56:	a58080e7          	jalr	-1448(ra) # 58aa <open>
    if(fd >= 0)
    ...
    3e68:	a46080e7          	jalr	-1466(ra) # 58aa <open>
    if(fd >= 0)
    3e6c:	fa0541e3          	bltz	a0,3e0e <iref+0x7e>
      close(fd);
    3e70:	00002097          	auipc	ra,0x2
    3e74:	a22080e7          	jalr	-1502(ra) # 5892 <close>
    ...
    3e94:	a4a080e7          	jalr	-1462(ra) # 58da <chdir>
    unlink("irefd");
    3e98:	854a                	mv	a0,s2
    3e9a:	00002097          	auipc	ra,0x2
    3e9e:	a20080e7          	jalr	-1504(ra) # 58ba <unlink>
  for(i = 0; i < NINODE + 1; i++){
  ...
  chdir("/");
    ...
    3eb2:	a2c080e7          	jalr	-1492(ra) # 58da <chdir>
}
...
0000000000003eca <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ee2:	9f4080e7          	jalr	-1548(ra) # 58d2 <mkdir>
    3ee6:	04054263          	bltz	a0,3f2a <openiputtest+0x60>
  pid = fork();
    3eea:	00002097          	auipc	ra,0x2
    3eee:	978080e7          	jalr	-1672(ra) # 5862 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3f06:	9a8080e7          	jalr	-1624(ra) # 58aa <open>
    if(fd >= 0){
    ...
    3f26:	948080e7          	jalr	-1720(ra) # 586a <exit>
    ...
    3f42:	92c080e7          	jalr	-1748(ra) # 586a <exit>
    printf("%s: fork failed\n", s);
    3f46:	85a6                	mv	a1,s1
  ...
  if(unlink("oidir") != 0){
    ...
    3fa0:	8ce080e7          	jalr	-1842(ra) # 586a <exit>
  wait(&xstatus);
    3fa4:	fdc40513          	addi	a0,s0,-36
    3fa8:	00002097          	auipc	ra,0x2
    3fac:	8ca080e7          	jalr	-1846(ra) # 5872 <wait>
  exit(xstatus);
...
0000000000003fbc <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fd4:	8ea080e7          	jalr	-1814(ra) # 58ba <unlink>
  int pid = fork();
    3fd8:	00002097          	auipc	ra,0x2
    3fdc:	88a080e7          	jalr	-1910(ra) # 5862 <fork>
  if(pid < 0){
  ...
  sleep(20); // two seconds
    ...
    3fec:	912080e7          	jalr	-1774(ra) # 58fa <sleep>
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4000:	8ae080e7          	jalr	-1874(ra) # 58aa <open>
    4004:	00002097          	auipc	ra,0x2
    4008:	88e080e7          	jalr	-1906(ra) # 5892 <close>
  wait(0);
    400c:	4501                	li	a0,0
    400e:	00002097          	auipc	ra,0x2
    4012:	864080e7          	jalr	-1948(ra) # 5872 <wait>
  sleep(10); // one second
    4016:	4529                	li	a0,10
    4018:	00002097          	auipc	ra,0x2
    401c:	8e2080e7          	jalr	-1822(ra) # 58fa <sleep>
}
    ...
    4042:	82c080e7          	jalr	-2004(ra) # 586a <exit>
...
000000000000408c <killstatus>:
{
    ...
    40a8:	7be080e7          	jalr	1982(ra) # 5862 <fork>
    40ac:	84aa                	mv	s1,a0
    if(pid1 < 0){
    ...
    40ba:	844080e7          	jalr	-1980(ra) # 58fa <sleep>
    kill(pid1);
    40be:	8526                	mv	a0,s1
    40c0:	00001097          	auipc	ra,0x1
    40c4:	7da080e7          	jalr	2010(ra) # 589a <kill>
    wait(&xst);
    40c8:	fcc40513          	addi	a0,s0,-52
    40cc:	00001097          	auipc	ra,0x1
    40d0:	7a6080e7          	jalr	1958(ra) # 5872 <wait>
    if(xst != -1) {
  ...
  exit(0);
    ...
    40e8:	786080e7          	jalr	1926(ra) # 586a <exit>
      printf("%s: fork failed\n", s);
    40ec:	85d2                	mv	a1,s4
    ...
    4104:	76a080e7          	jalr	1898(ra) # 586a <exit>
        getpid();
    4108:	00001097          	auipc	ra,0x1
    410c:	7e2080e7          	jalr	2018(ra) # 58ea <getpid>
      while(1) {
    ...
    412a:	744080e7          	jalr	1860(ra) # 586a <exit>
...
000000000000412e <preempt>:
{
  ...
  pid1 = fork();
    ...
    4144:	722080e7          	jalr	1826(ra) # 5862 <fork>
  if(pid1 < 0) {
  ...
  if(pid1 == 0)
    ...
    416a:	704080e7          	jalr	1796(ra) # 586a <exit>
  pid2 = fork();
    416e:	00001097          	auipc	ra,0x1
    4172:	6f4080e7          	jalr	1780(ra) # 5862 <fork>
    4176:	89aa                	mv	s3,a0
  if(pid2 < 0) {
  ...
  if(pid2 == 0)
    ...
    4198:	6d6080e7          	jalr	1750(ra) # 586a <exit>
  pipe(pfds);
    419c:	fc840513          	addi	a0,s0,-56
    41a0:	00001097          	auipc	ra,0x1
    41a4:	6da080e7          	jalr	1754(ra) # 587a <pipe>
  pid3 = fork();
    41a8:	00001097          	auipc	ra,0x1
    41ac:	6ba080e7          	jalr	1722(ra) # 5862 <fork>
    41b0:	892a                	mv	s2,a0
  if(pid3 < 0) {
  ...
  if(pid3 == 0){
    ...
    41c0:	6d6080e7          	jalr	1750(ra) # 5892 <close>
    ...
    4206:	668080e7          	jalr	1640(ra) # 586a <exit>
  ...
  close(pfds[1]);
    ...
    4226:	670080e7          	jalr	1648(ra) # 5892 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    423c:	64a080e7          	jalr	1610(ra) # 5882 <read>
    4240:	4785                	li	a5,1
  ...
  close(pfds[0]);
    ...
    4270:	626080e7          	jalr	1574(ra) # 5892 <close>
  printf("kill... ");
  ...
  kill(pid1);
    ...
    428a:	614080e7          	jalr	1556(ra) # 589a <kill>
  kill(pid2);
    428e:	854e                	mv	a0,s3
    4290:	00001097          	auipc	ra,0x1
    4294:	60a080e7          	jalr	1546(ra) # 589a <kill>
  kill(pid3);
    4298:	854a                	mv	a0,s2
    429a:	00001097          	auipc	ra,0x1
    429e:	600080e7          	jalr	1536(ra) # 589a <kill>
  printf("wait... ");
  ...
  wait(0);
    ...
    42b8:	5be080e7          	jalr	1470(ra) # 5872 <wait>
  wait(0);
    42bc:	4501                	li	a0,0
    42be:	00001097          	auipc	ra,0x1
    42c2:	5b4080e7          	jalr	1460(ra) # 5872 <wait>
  wait(0);
    42c6:	4501                	li	a0,0
    42c8:	00001097          	auipc	ra,0x1
    42cc:	5aa080e7          	jalr	1450(ra) # 5872 <wait>
...
00000000000042d2 <reparent>:
{
  ...
  int master_pid = getpid();
    ...
    42e8:	606080e7          	jalr	1542(ra) # 58ea <getpid>
    42ec:	8a2a                	mv	s4,a0
    42ee:	0c800913          	li	s2,200
    int pid = fork();
    42f2:	00001097          	auipc	ra,0x1
    42f6:	570080e7          	jalr	1392(ra) # 5862 <fork>
    42fa:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    4308:	56e080e7          	jalr	1390(ra) # 5872 <wait>
  ...
  exit(0);
    ...
    431c:	552080e7          	jalr	1362(ra) # 586a <exit>
      printf("%s: fork failed\n", s);
    4320:	85ce                	mv	a1,s3
    ...
    4338:	536080e7          	jalr	1334(ra) # 586a <exit>
        printf("%s: wait wrong pid\n", s);
    433c:	85ce                	mv	a1,s3
    ...
    4354:	51a080e7          	jalr	1306(ra) # 586a <exit>
      int pid2 = fork();
    4358:	00001097          	auipc	ra,0x1
    435c:	50a080e7          	jalr	1290(ra) # 5862 <fork>
      if(pid2 < 0){
    4360:	00054763          	bltz	a0,436e <reparent+0x9c>
      exit(0);
    4364:	4501                	li	a0,0
    4366:	00001097          	auipc	ra,0x1
    436a:	504080e7          	jalr	1284(ra) # 586a <exit>
        kill(master_pid);
    436e:	8552                	mv	a0,s4
    4370:	00001097          	auipc	ra,0x1
    4374:	52a080e7          	jalr	1322(ra) # 589a <kill>
        exit(1);
    4378:	4505                	li	a0,1
    437a:	00001097          	auipc	ra,0x1
    437e:	4f0080e7          	jalr	1264(ra) # 586a <exit>
...
0000000000004382 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    439e:	4e0080e7          	jalr	1248(ra) # 587a <pipe>
    ...
    43fa:	494080e7          	jalr	1172(ra) # 588a <write>
      for(;;) sleep(1000);
    43fe:	3e800513          	li	a0,1000
    4402:	00001097          	auipc	ra,0x1
    4406:	4f8080e7          	jalr	1272(ra) # 58fa <sleep>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    4416:	450080e7          	jalr	1104(ra) # 5862 <fork>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    4458:	446080e7          	jalr	1094(ra) # 589a <kill>
    wait(0);
    445c:	4501                	li	a0,0
    445e:	00001097          	auipc	ra,0x1
    4462:	414080e7          	jalr	1044(ra) # 5872 <wait>
  ...
  pid = fork();
    ...
    4472:	3f4080e7          	jalr	1012(ra) # 5862 <fork>
    4476:	84aa                	mv	s1,a0
  if(pid < 0){
  ...
  wait(&xstatus);
    ...
    4486:	3f0080e7          	jalr	1008(ra) # 5872 <wait>
  if(xstatus != -1 && xstatus != 2)
    ...
    44c4:	3aa080e7          	jalr	938(ra) # 586a <exit>
    printf("%s: fork failed\n", s);
    44c8:	85ca                	mv	a1,s2
    ...
    44e0:	38e080e7          	jalr	910(ra) # 586a <exit>
    a = sbrk(0);
    44e4:	4501                	li	a0,0
    44e6:	00001097          	auipc	ra,0x1
    44ea:	40c080e7          	jalr	1036(ra) # 58f2 <sbrk>
    44ee:	89aa                	mv	s3,a0
    sbrk(10*BIG);
    44f0:	3e800537          	lui	a0,0x3e800
    44f4:	00001097          	auipc	ra,0x1
    44f8:	3fe080e7          	jalr	1022(ra) # 58f2 <sbrk>
    ...
    452c:	342080e7          	jalr	834(ra) # 586a <exit>
    exit(1);
    4530:	4505                	li	a0,1
    4532:	00001097          	auipc	ra,0x1
    4536:	338080e7          	jalr	824(ra) # 586a <exit>
...
000000000000453a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    454e:	318080e7          	jalr	792(ra) # 5862 <fork>
    m1 = 0;
    4552:	4481                	li	s1,0
  ...
  if((pid = fork()) == 0){
    ...
    4598:	2d6080e7          	jalr	726(ra) # 586a <exit>
    ...
    45b4:	2ba080e7          	jalr	698(ra) # 586a <exit>
    wait(&xstatus);
    45b8:	fcc40513          	addi	a0,s0,-52
    45bc:	00001097          	auipc	ra,0x1
    45c0:	2b6080e7          	jalr	694(ra) # 5872 <wait>
    if(xstatus == -1){
    ...
    45d2:	29c080e7          	jalr	668(ra) # 586a <exit>
      exit(0);
    45d6:	4501                	li	a0,0
    45d8:	00001097          	auipc	ra,0x1
    45dc:	292080e7          	jalr	658(ra) # 586a <exit>
...
00000000000045e0 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    4604:	2ba080e7          	jalr	698(ra) # 58ba <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    ...
    4618:	296080e7          	jalr	662(ra) # 58aa <open>
  if(fd < 0){
    461c:	04054a63          	bltz	a0,4670 <sharedfd+0x90>
    4620:	892a                	mv	s2,a0
  pid = fork();
    4622:	00001097          	auipc	ra,0x1
    4626:	240080e7          	jalr	576(ra) # 5862 <fork>
    462a:	89aa                	mv	s3,a0
  memset(buf, pid==0?'c':'p', sizeof(buf));
    ...
    4640:	02a080e7          	jalr	42(ra) # 5666 <memset>
    ...
    4654:	23a080e7          	jalr	570(ra) # 588a <write>
    4658:	47a9                	li	a5,10
  ...
  if(pid == 0) {
    ...
    466c:	202080e7          	jalr	514(ra) # 586a <exit>
    ...
    4688:	1e6080e7          	jalr	486(ra) # 586a <exit>
    ...
    46a4:	1ca080e7          	jalr	458(ra) # 586a <exit>
    wait(&xstatus);
    46a8:	f9c40513          	addi	a0,s0,-100
    46ac:	00001097          	auipc	ra,0x1
    46b0:	1c6080e7          	jalr	454(ra) # 5872 <wait>
    if(xstatus != 0)
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4702:	184080e7          	jalr	388(ra) # 5882 <read>
    ...
    4728:	146080e7          	jalr	326(ra) # 586a <exit>
        nc++;
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    478a:	0e4080e7          	jalr	228(ra) # 586a <exit>
    exit(0);
    478e:	4501                	li	a0,0
    4790:	00001097          	auipc	ra,0x1
    4794:	0da080e7          	jalr	218(ra) # 586a <exit>
...
0000000000004798 <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    47fc:	0c2080e7          	jalr	194(ra) # 58ba <unlink>
    pid = fork();
    4800:	00001097          	auipc	ra,0x1
    4804:	062080e7          	jalr	98(ra) # 5862 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4820:	056080e7          	jalr	86(ra) # 5872 <wait>
    if(xstatus != 0)
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    486a:	004080e7          	jalr	4(ra) # 586a <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    486e:	20200593          	li	a1,514
    4872:	854e                	mv	a0,s3
    4874:	00001097          	auipc	ra,0x1
    4878:	036080e7          	jalr	54(ra) # 58aa <open>
    487c:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    4896:	dd4080e7          	jalr	-556(ra) # 5666 <memset>
    489a:	44b1                	li	s1,12
    ...
    48b0:	fde080e7          	jalr	-34(ra) # 588a <write>
    48b4:	85aa                	mv	a1,a0
    ...
    48c8:	fa6080e7          	jalr	-90(ra) # 586a <exit>
    ...
    48e4:	f8a080e7          	jalr	-118(ra) # 586a <exit>
    ...
    48fe:	f70080e7          	jalr	-144(ra) # 586a <exit>
      exit(xstatus);
    4902:	00001097          	auipc	ra,0x1
    4906:	f68080e7          	jalr	-152(ra) # 586a <exit>
          printf("wrong char\n", s);
    490a:	85e6                	mv	a1,s9
    ...
    4922:	f4c080e7          	jalr	-180(ra) # 586a <exit>
      total += n;
    ...
    4934:	f52080e7          	jalr	-174(ra) # 5882 <read>
    ...
    4964:	f32080e7          	jalr	-206(ra) # 5892 <close>
    if(total != N*SZ){
    4968:	03a91963          	bne	s2,s10,499a <fourfiles+0x202>
    unlink(fname);
    496c:	8562                	mv	a0,s8
    496e:	00001097          	auipc	ra,0x1
    4972:	f4c080e7          	jalr	-180(ra) # 58ba <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    498a:	f24080e7          	jalr	-220(ra) # 58aa <open>
    498e:	89aa                	mv	s3,a0
    total = 0;
    ...
    49b2:	ebc080e7          	jalr	-324(ra) # 586a <exit>
}
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a16:	eb8080e7          	jalr	-328(ra) # 58ca <link>
    if(pid == 0) {
    ...
    4a34:	e7a080e7          	jalr	-390(ra) # 58aa <open>
      if(fd < 0){
    ...
    4a56:	e18080e7          	jalr	-488(ra) # 586a <exit>
      link("C0", file);
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ad2:	d9c080e7          	jalr	-612(ra) # 586a <exit>
      fa[i] = 1;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4aee:	d98080e7          	jalr	-616(ra) # 5882 <read>
    ...
    4b42:	d2c080e7          	jalr	-724(ra) # 586a <exit>
  close(fd);
    4b46:	854a                	mv	a0,s2
    4b48:	00001097          	auipc	ra,0x1
    4b4c:	d4a080e7          	jalr	-694(ra) # 5892 <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    4b7a:	cf4080e7          	jalr	-780(ra) # 586a <exit>
      printf("%s: fork failed\n", s);
    4b7e:	85ce                	mv	a1,s3
  ...
  for(i = 0; i < N; i++){
    ...
    4c3e:	c28080e7          	jalr	-984(ra) # 5862 <fork>
    4c42:	892a                	mv	s2,a0
    if(pid < 0){
    ...
    4c62:	c5c080e7          	jalr	-932(ra) # 58ba <unlink>
      unlink(file);
    4c66:	fa840513          	addi	a0,s0,-88
    4c6a:	00001097          	auipc	ra,0x1
    4c6e:	c50080e7          	jalr	-944(ra) # 58ba <unlink>
      unlink(file);
    ...
    4caa:	bc4080e7          	jalr	-1084(ra) # 586a <exit>
      close(fd);
    4cae:	00001097          	auipc	ra,0x1
    4cb2:	be4080e7          	jalr	-1052(ra) # 5892 <close>
    if(pid == 0) {
    4cb6:	bb65                	j	4a6e <concreate+0x9a>
      close(fd);
    4cb8:	00001097          	auipc	ra,0x1
    4cbc:	bda080e7          	jalr	-1062(ra) # 5892 <close>
      wait(&xstatus);
    4cc0:	f6c40513          	addi	a0,s0,-148
    4cc4:	00001097          	auipc	ra,0x1
    4cc8:	bae080e7          	jalr	-1106(ra) # 5872 <wait>
      if(xstatus != 0)
  ...
  for(i = 0; i < N; i++){
    ...
    4cea:	bd4080e7          	jalr	-1068(ra) # 58ba <unlink>
    pid = fork();
    4cee:	00001097          	auipc	ra,0x1
    4cf2:	b74080e7          	jalr	-1164(ra) # 5862 <fork>
    if(pid && (i % 3) == 1){
    ...
    4d0e:	ba0080e7          	jalr	-1120(ra) # 58aa <open>
      if(fd < 0){
...
0000000000004d2e <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4d4e:	b70080e7          	jalr	-1168(ra) # 58ba <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    ...
    4d62:	b4c080e7          	jalr	-1204(ra) # 58aa <open>
    4d66:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    4d68:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  if(fd < 0){
    ...
    4d84:	8e6080e7          	jalr	-1818(ra) # 5666 <memset>
    if(write(fd, buf, SZ) != SZ){
    4d88:	25800613          	li	a2,600
    4d8c:	85ca                	mv	a1,s2
    4d8e:	854e                	mv	a0,s3
    4d90:	00001097          	auipc	ra,0x1
    4d94:	afa080e7          	jalr	-1286(ra) # 588a <write>
  ...
  if(fd < 0){
    ...
    4de0:	aa6080e7          	jalr	-1370(ra) # 5882 <read>
    if(cc < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e2c:	a42080e7          	jalr	-1470(ra) # 586a <exit>
    ...
    4e48:	a26080e7          	jalr	-1498(ra) # 586a <exit>
    ...
    4e64:	a0a080e7          	jalr	-1526(ra) # 586a <exit>
    ...
    4e80:	9ee080e7          	jalr	-1554(ra) # 586a <exit>
    ...
    4e9c:	9d2080e7          	jalr	-1582(ra) # 586a <exit>
    ...
    4eb8:	9b6080e7          	jalr	-1610(ra) # 586a <exit>
  close(fd);
    4ebc:	8552                	mv	a0,s4
    4ebe:	00001097          	auipc	ra,0x1
    4ec2:	9d4080e7          	jalr	-1580(ra) # 5892 <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    4edc:	9e2080e7          	jalr	-1566(ra) # 58ba <unlink>
}
    ...
    4f0a:	964080e7          	jalr	-1692(ra) # 586a <exit>
...
0000000000004f0e <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4fb8:	8f6080e7          	jalr	-1802(ra) # 58aa <open>
    4fbc:	892a                	mv	s2,a0
    if(fd < 0){
  ...
  while(nfiles >= 0){
    ...
    5032:	88c080e7          	jalr	-1908(ra) # 58ba <unlink>
    nfiles--;
  ...
  printf("fsfull test finished\n");
    ...
    507c:	812080e7          	jalr	-2030(ra) # 588a <write>
      if(cc < BSIZE)
    ...
    50a2:	7f4080e7          	jalr	2036(ra) # 5892 <close>
    if(total == 0)
...
00000000000050ae <badwrite>:
{
  ...
  unlink("junk");
    ...
    50ca:	7f4080e7          	jalr	2036(ra) # 58ba <unlink>
    ...
    50ea:	7c4080e7          	jalr	1988(ra) # 58aa <open>
    50ee:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    50fc:	792080e7          	jalr	1938(ra) # 588a <write>
    close(fd);
    5100:	8526                	mv	a0,s1
    5102:	00000097          	auipc	ra,0x0
    5106:	790080e7          	jalr	1936(ra) # 5892 <close>
    unlink("junk");
    510a:	854e                	mv	a0,s3
    510c:	00000097          	auipc	ra,0x0
    5110:	7ae080e7          	jalr	1966(ra) # 58ba <unlink>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    512a:	784080e7          	jalr	1924(ra) # 58aa <open>
    512e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5142:	74c080e7          	jalr	1868(ra) # 588a <write>
    5146:	4785                	li	a5,1
    ...
    5162:	70c080e7          	jalr	1804(ra) # 586a <exit>
    ...
    517c:	6f2080e7          	jalr	1778(ra) # 586a <exit>
    printf("open junk failed\n");
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    51d4:	6aa080e7          	jalr	1706(ra) # 587a <pipe>
  ...
  int pid = fork();
    ...
    51e0:	686080e7          	jalr	1670(ra) # 5862 <fork>
  ...
  if(pid == 0){
    ...
    51f2:	6a4080e7          	jalr	1700(ra) # 5892 <close>
    ...
    5208:	6ee080e7          	jalr	1774(ra) # 58f2 <sbrk>
      if(a == 0xffffffffffffffff){
    ...
    5224:	66a080e7          	jalr	1642(ra) # 588a <write>
    5228:	4785                	li	a5,1
    ...
    5244:	62a080e7          	jalr	1578(ra) # 586a <exit>
    printf("pipe() failed in countfree()\n");
    ...
    525e:	610080e7          	jalr	1552(ra) # 586a <exit>
    printf("fork failed in countfree()\n");
    ...
    5278:	5f6080e7          	jalr	1526(ra) # 586a <exit>
      }
    }
    ...
    5282:	5ec080e7          	jalr	1516(ra) # 586a <exit>
  }

  close(fds[1]);
    5286:	fcc42503          	lw	a0,-52(s0)
    528a:	00000097          	auipc	ra,0x0
    528e:	608080e7          	jalr	1544(ra) # 5892 <close>
  ...
  while(1){
    ...
    52a2:	5e4080e7          	jalr	1508(ra) # 5882 <read>
    if(cc < 0){
  ...
  while(1){
    ...
    52c6:	5a8080e7          	jalr	1448(ra) # 586a <exit>
  }

  close(fds[0]);
    52ca:	fc842503          	lw	a0,-56(s0)
    52ce:	00000097          	auipc	ra,0x0
    52d2:	5c4080e7          	jalr	1476(ra) # 5892 <close>
  wait((int*)0);
    52d6:	4501                	li	a0,0
    52d8:	00000097          	auipc	ra,0x0
    52dc:	59a080e7          	jalr	1434(ra) # 5872 <wait>
...
run(void f(char *), char *s) {
  ...
  if((pid = fork()) < 0) {
    ...
    5314:	552080e7          	jalr	1362(ra) # 5862 <fork>
  ...
  if(pid == 0) {
    ...
    5326:	550080e7          	jalr	1360(ra) # 5872 <wait>
    if(xstatus != 0) 
    ...
    536a:	504080e7          	jalr	1284(ra) # 586a <exit>
    f(s);
    536e:	854a                	mv	a0,s2
    5370:	9482                	jalr	s1
    exit(0);
    ...
    5378:	4f6080e7          	jalr	1270(ra) # 586a <exit>
      printf("OK\n");
...
main(int argc, char *argv[])
{
  ...
  if(fail){
    ...
    5454:	41a080e7          	jalr	1050(ra) # 586a <exit>
    5458:	84ae                	mv	s1,a1
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5468:	1ac080e7          	jalr	428(ra) # 5610 <strcmp>
    ...
    547e:	196080e7          	jalr	406(ra) # 5610 <strcmp>
    ...
    54aa:	3c4080e7          	jalr	964(ra) # 586a <exit>
          exit(1);
    54ae:	4505                	li	a0,1
    54b0:	00000097          	auipc	ra,0x0
    54b4:	3ba080e7          	jalr	954(ra) # 586a <exit>
    ...
    54d0:	39e080e7          	jalr	926(ra) # 586a <exit>
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    54e4:	130080e7          	jalr	304(ra) # 5610 <strcmp>
  ...
  if(fail){
    ...
    5516:	358080e7          	jalr	856(ra) # 586a <exit>
  } else {
    ...
    5530:	33e080e7          	jalr	830(ra) # 586a <exit>
        printf("SOME TESTS FAILED\n");
    5534:	8556                	mv	a0,s5
...
_start()
{
    ...
    55de:	e406                	sd	ra,8(sp)
    55e0:	e022                	sd	s0,0(sp)
    55e2:	0800                	addi	s0,sp,16
  extern int main(void);
  exit(main());
    55e4:	00000097          	auipc	ra,0x0
    55e8:	daa080e7          	jalr	-598(ra) # 538e <main>
    55ec:	00000097          	auipc	ra,0x0
    55f0:	27e080e7          	jalr	638(ra) # 586a <exit>
...
atoi(const char *s)
{
  ...
  while('0' <= *s && *s <= '9')
    579a:	0006c603          	lbu	a2,0(a3) # 1000 <bigdir+0x9e>
