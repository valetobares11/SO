...
fmtname(char *path)
{
  ...
  7a:	436080e7          	jalr	1078(ra) # 4ac <memmove>
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  7e:	8526                	mv	a0,s1
...
ls(char *path)
{
  ...
  de:	4c8080e7          	jalr	1224(ra) # 5a2 <open>
  ...
  f0:	4ce080e7          	jalr	1230(ra) # 5ba <fstat>
 ...
 13a:	454080e7          	jalr	1108(ra) # 58a <close>
}
 ...
 190:	3fe080e7          	jalr	1022(ra) # 58a <close>
    return;
 ...
 21c:	362080e7          	jalr	866(ra) # 57a <read>
 220:	47c1                	li	a5,16
 ...
 238:	278080e7          	jalr	632(ra) # 4ac <memmove>
      p[DIRSIZ] = 0;
 ...
 24c:	1d4080e7          	jalr	468(ra) # 41c <stat>
...
main(int argc, char *argv[])
{
 ...
 2b6:	2b0080e7          	jalr	688(ra) # 562 <exit>
    ls(".");
 ...
 2d0:	296080e7          	jalr	662(ra) # 562 <exit>

00000000000002d4 <_start>:
...
_start()
{
 ...
 2e0:	f9e080e7          	jalr	-98(ra) # 27a <main>
 2e4:	00000097          	auipc	ra,0x0
 2e8:	27e080e7          	jalr	638(ra) # 562 <exit>
...
strlen(const char *s)
{
 ...
 342:	87aa                	mv	a5,a0
 344:	4685                	li	a3,1
 346:	9e89                	subw	a3,a3,a0
 348:	00f6853b          	addw	a0,a3,a5
 34c:	0785                	addi	a5,a5,1
 34e:	fff7c703          	lbu	a4,-1(a5)
 352:	fb7d                	bnez	a4,348 <strlen+0x14>
    ;
  return n;
}
 354:	6422                	ld	s0,8(sp)
...
memset(void *dst, int c, uint n)
{
 ...
 362:	0800                	addi	s0,sp,16
  ...
  int i;
  for(i = 0; i < n; i++){
 364:	ce09                	beqz	a2,37e <memset+0x20>
 366:	87aa                	mv	a5,a0
 368:	fff6071b          	addiw	a4,a2,-1
 36c:	1702                	slli	a4,a4,0x20
 36e:	9301                	srli	a4,a4,0x20
 370:	0705                	addi	a4,a4,1
 372:	972a                	add	a4,a4,a0
    cdst[i] = c;
 374:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
 378:	0785                	addi	a5,a5,1
 37a:	fee79de3          	bne	a5,a4,374 <memset+0x16>
  }
  return dst;
}
 37e:	6422                	ld	s0,8(sp)
...
gets(char *buf, int max)
{
 ...
 3de:	1a0080e7          	jalr	416(ra) # 57a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 430:	176080e7          	jalr	374(ra) # 5a2 <open>
  if(fd < 0)
 ...
 440:	17e080e7          	jalr	382(ra) # 5ba <fstat>
 444:	892a                	mv	s2,a0
  close(fd);
 446:	8526                	mv	a0,s1
 448:	00000097          	auipc	ra,0x0
 44c:	142080e7          	jalr	322(ra) # 58a <close>
  return r;
}
 450:	854a                	mv	a0,s2
...
atoi(const char *s)
{
 ...
 466:	0800                	addi	s0,sp,16
  ...
  n = 0;
  while('0' <= *s && *s <= '9')
 468:	00054603          	lbu	a2,0(a0)
 46c:	fd06079b          	addiw	a5,a2,-48
 470:	0ff7f793          	andi	a5,a5,255
 474:	4725                	li	a4,9
 476:	02f76963          	bltu	a4,a5,4a8 <atoi+0x46>
 47a:	86aa                	mv	a3,a0
  n = 0;
 47c:	4501                	li	a0,0
  while('0' <= *s && *s <= '9')
 ...
 48c:	9fb1                	addw	a5,a5,a2
 48e:	fd07851b          	addiw	a0,a5,-48
  while('0' <= *s && *s <= '9')
 492:	0006c603          	lbu	a2,0(a3)
 496:	fd06071b          	addiw	a4,a2,-48
 49a:	0ff77713          	andi	a4,a4,255
 49e:	fee5f1e3          	bgeu	a1,a4,480 <atoi+0x1e>
  return n;
}
 4a2:	6422                	ld	s0,8(sp)
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 4b0:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  if (src > dst) {
 4b2:	02b57663          	bgeu	a0,a1,4de <memmove+0x32>
    while(n-- > 0)
 4b6:	02c05163          	blez	a2,4d8 <memmove+0x2c>
 ...
 4d0:	fed70fa3          	sb	a3,-1(a4)
    while(n-- > 0)
 4d4:	fee79ae3          	bne	a5,a4,4c8 <memmove+0x1c>
    src += n;
    while(n-- > 0)
      *--dst = *--src;
  }
 ...
 4e2:	95b2                	add	a1,a1,a2
    while(n-- > 0)
 4e4:	fec05ae3          	blez	a2,4d8 <memmove+0x2c>
 ...
 4fe:	00d70023          	sb	a3,0(a4)
    while(n-- > 0)
 502:	fee79ae3          	bne	a5,a4,4f6 <memmove+0x4a>
 506:	bfc9                	j	4d8 <memmove+0x2c>
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 54e:	f62080e7          	jalr	-158(ra) # 4ac <memmove>
}
 552:	60a2                	ld	ra,8(sp)
 554:	6402                	ld	s0,0(sp)
...
malloc(uint nbytes)
{
 ...
 a70:	b7e080e7          	jalr	-1154(ra) # 5ea <sbrk>
  if(p == (char*)-1)
