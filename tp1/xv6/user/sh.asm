...
getcmd(char *buf, int nbuf)
{
  ...
  memset(buf, 0, nbuf);
      ...
      2c:	bb6080e7          	jalr	-1098(ra) # bde <memset>
  gets(buf, nbuf);
      30:	85ca                	mv	a1,s2
      32:	8526                	mv	a0,s1
      34:	00001097          	auipc	ra,0x1
      38:	bf4080e7          	jalr	-1036(ra) # c28 <gets>
  if(buf[0] == 0) // EOF
...
panic(char *s)
{
  ...
  exit(1);
      ...
      76:	d70080e7          	jalr	-656(ra) # de2 <exit>
...
fork1(void)
{
  ...
  pid = fork();
      ...
      86:	d58080e7          	jalr	-680(ra) # dda <fork>
  if(pid == -1)
      8a:	57fd                	li	a5,-1
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exit(1);
      ...
      da:	d0c080e7          	jalr	-756(ra) # de2 <exit>
    panic("runcmd");
    ...
    exec(ecmd->argv[0], ecmd->argv);
      ...
      fa:	d24080e7          	jalr	-732(ra) # e1a <exec>
  ...
  exit(0);
     ...
     118:	cce080e7          	jalr	-818(ra) # de2 <exit>
      exit(1);
     11c:	4505                	li	a0,1
     11e:	00001097          	auipc	ra,0x1
     122:	cc4080e7          	jalr	-828(ra) # de2 <exit>
    close(rcmd->fd);
     126:	5148                	lw	a0,36(a0)
     128:	00001097          	auipc	ra,0x1
     12c:	ce2080e7          	jalr	-798(ra) # e0a <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     130:	508c                	lw	a1,32(s1)
     132:	6888                	ld	a0,16(s1)
     134:	00001097          	auipc	ra,0x1
     138:	cee080e7          	jalr	-786(ra) # e22 <open>
    ...
    runcmd(rcmd->cmd);
     ...
     164:	c82080e7          	jalr	-894(ra) # de2 <exit>
    if(fork1() == 0)
    ...
    wait(0);
     ...
     178:	c76080e7          	jalr	-906(ra) # dea <wait>
    runcmd(lcmd->right);
    ...
    if(pipe(p) < 0)
     ...
     198:	c5e080e7          	jalr	-930(ra) # df2 <pipe>
    ...
    close(p[0]);
     ...
     1bc:	c52080e7          	jalr	-942(ra) # e0a <close>
    close(p[1]);
     1c0:	fdc42503          	lw	a0,-36(s0)
     1c4:	00001097          	auipc	ra,0x1
     1c8:	c46080e7          	jalr	-954(ra) # e0a <close>
    wait(0);
     1cc:	4501                	li	a0,0
     1ce:	00001097          	auipc	ra,0x1
     1d2:	c1c080e7          	jalr	-996(ra) # dea <wait>
    wait(0);
     1d6:	4501                	li	a0,0
     1d8:	00001097          	auipc	ra,0x1
     1dc:	c12080e7          	jalr	-1006(ra) # dea <wait>
    break;
     ...
     1f8:	c16080e7          	jalr	-1002(ra) # e0a <close>
      dup(p[1]);
     1fc:	fdc42503          	lw	a0,-36(s0)
     200:	00001097          	auipc	ra,0x1
     204:	c5a080e7          	jalr	-934(ra) # e5a <dup>
      close(p[0]);
     208:	fd842503          	lw	a0,-40(s0)
     20c:	00001097          	auipc	ra,0x1
     210:	bfe080e7          	jalr	-1026(ra) # e0a <close>
      close(p[1]);
     214:	fdc42503          	lw	a0,-36(s0)
     218:	00001097          	auipc	ra,0x1
     21c:	bf2080e7          	jalr	-1038(ra) # e0a <close>
      runcmd(pcmd->left);
     220:	6488                	ld	a0,8(s1)
     ...
     22e:	be0080e7          	jalr	-1056(ra) # e0a <close>
      dup(p[0]);
     232:	fd842503          	lw	a0,-40(s0)
     236:	00001097          	auipc	ra,0x1
     23a:	c24080e7          	jalr	-988(ra) # e5a <dup>
      close(p[0]);
     23e:	fd842503          	lw	a0,-40(s0)
     242:	00001097          	auipc	ra,0x1
     246:	bc8080e7          	jalr	-1080(ra) # e0a <close>
      close(p[1]);
     24a:	fdc42503          	lw	a0,-36(s0)
     24e:	00001097          	auipc	ra,0x1
     252:	bbc080e7          	jalr	-1092(ra) # e0a <close>
      runcmd(pcmd->right);
...
execcmd(void)
{
  ...
  memset(cmd, 0, sizeof(*cmd));
     ...
     298:	94a080e7          	jalr	-1718(ra) # bde <memset>
  cmd->type = EXEC;
     29c:	4785                	li	a5,1
     29e:	c09c                	sw	a5,0(s1)
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  memset(cmd, 0, sizeof(*cmd));
     ...
     2e2:	900080e7          	jalr	-1792(ra) # bde <memset>
  cmd->type = REDIR;
     2e6:	4789                	li	a5,2
     2e8:	c09c                	sw	a5,0(s1)
  cmd->cmd = subcmd;
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  memset(cmd, 0, sizeof(*cmd));
     ...
     33a:	8a8080e7          	jalr	-1880(ra) # bde <memset>
  cmd->type = PIPE;
     33e:	478d                	li	a5,3
     340:	c09c                	sw	a5,0(s1)
  cmd->left = left;
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  memset(cmd, 0, sizeof(*cmd));
     ...
     380:	862080e7          	jalr	-1950(ra) # bde <memset>
  cmd->type = LIST;
     384:	4791                	li	a5,4
     386:	c09c                	sw	a5,0(s1)
  cmd->left = left;
...
backcmd(struct cmd *subcmd)
{
  ...
  memset(cmd, 0, sizeof(*cmd));
     ...
     3c2:	820080e7          	jalr	-2016(ra) # bde <memset>
  cmd->type = BACK;
     3c6:	4795                	li	a5,5
     3c8:	c09c                	sw	a5,0(s1)
  cmd->cmd = subcmd;
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     410:	7f8080e7          	jalr	2040(ra) # c04 <strchr>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     474:	794080e7          	jalr	1940(ra) # c04 <strchr>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4e6:	722080e7          	jalr	1826(ra) # c04 <strchr>
     4ea:	e505                	bnez	a0,512 <gettoken+0x136>
     4ec:	0004c583          	lbu	a1,0(s1)
     4f0:	8556                	mv	a0,s5
     4f2:	00000097          	auipc	ra,0x0
     4f6:	712080e7          	jalr	1810(ra) # c04 <strchr>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     548:	6c0080e7          	jalr	1728(ra) # c04 <strchr>
  ...
  *ps = s;
  ...
  return *s && strchr(toks, *s);
     ...
     578:	690080e7          	jalr	1680(ra) # c04 <strchr>
...
00000000000009d8 <parsecmd>:
{
  ...
  es = s + strlen(s);
     ...
     9ee:	1ca080e7          	jalr	458(ra) # bb4 <strlen>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a82:	3a4080e7          	jalr	932(ra) # e22 <open>
    ...
    if(fd >= 3){
     ...
     a94:	37a080e7          	jalr	890(ra) # e0a <close>
  while(getcmd(buf, sizeof(buf)) >= 0){
     a98:	00001497          	auipc	s1,0x1
     a9c:	9e048493          	addi	s1,s1,-1568 # 1478 <buf.1133>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	9d3a0a13          	addi	s4,s4,-1581 # 147b <buf.1133+0x3>
    ...
    wait(0);
     ...
     aca:	324080e7          	jalr	804(ra) # dea <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b02:	0b6080e7          	jalr	182(ra) # bb4 <strlen>
     ...
     b1a:	33c080e7          	jalr	828(ra) # e52 <chdir>
     ...
     b36:	94650513          	addi	a0,a0,-1722 # 1478 <buf.1133>
  ...
  exit(0);
     ...
     b50:	296080e7          	jalr	662(ra) # de2 <exit>

0000000000000b54 <_start>:
...
_start()
{
  ...
  exit(main());
     ...
     b60:	f04080e7          	jalr	-252(ra) # a60 <main>
     b64:	00000097          	auipc	ra,0x0
     b68:	27e080e7          	jalr	638(ra) # de2 <exit>

0000000000000b6c <strcpy>:
}
...
strcpy(char *s, const char *t)
{
  ...
  while((*s++ = *t++) != 0)
     ...
     b78:	fff5c703          	lbu	a4,-1(a1)
     b7c:	fee78fa3          	sb	a4,-1(a5)
     b80:	fb75                	bnez	a4,b74 <strcpy+0x8>
    ;
  return os;
}
     b82:	6422                	ld	s0,8(sp)
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q)
     ...
     b92:	cb91                	beqz	a5,ba6 <strcmp+0x1e>
     b94:	0005c703          	lbu	a4,0(a1)
     b98:	00f71763          	bne	a4,a5,ba6 <strcmp+0x1e>
    p++, q++;
     b9c:	0505                	addi	a0,a0,1
     b9e:	0585                	addi	a1,a1,1
  while(*p && *p == *q)
     ba0:	00054783          	lbu	a5,0(a0)
     ba4:	fbe5                	bnez	a5,b94 <strcmp+0xc>
  return (uchar)*p - (uchar)*q;
     ba6:	0005c503          	lbu	a0,0(a1)
}
     baa:	40a7853b          	subw	a0,a5,a0
     bae:	6422                	ld	s0,8(sp)
     bb0:	0141                	addi	sp,sp,16
     bb2:	8082                	ret

0000000000000bb4 <strlen>:
...
strlen(const char *s)
{
  ...
  for(n = 0; s[n]; n++)
     bda:	4501                	li	a0,0
     bdc:	bfe5                	j	bd4 <strlen+0x20>

0000000000000bde <memset>:
...
memset(void *dst, int c, uint n)
{
  ...
  int i;
  for(i = 0; i < n; i++){
     be4:	ce09                	beqz	a2,bfe <memset+0x20>
     be6:	87aa                	mv	a5,a0
     be8:	fff6071b          	addiw	a4,a2,-1
     bec:	1702                	slli	a4,a4,0x20
     bee:	9301                	srli	a4,a4,0x20
     bf0:	0705                	addi	a4,a4,1
     bf2:	972a                	add	a4,a4,a0
    cdst[i] = c;
     bf4:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
     bf8:	0785                	addi	a5,a5,1
     bfa:	fee79de3          	bne	a5,a4,bf4 <memset+0x16>
  }
  return dst;
}
     bfe:	6422                	ld	s0,8(sp)
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c5e:	1a0080e7          	jalr	416(ra) # dfa <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     cb0:	176080e7          	jalr	374(ra) # e22 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     cc0:	17e080e7          	jalr	382(ra) # e3a <fstat>
     cc4:	892a                	mv	s2,a0
  close(fd);
     cc6:	8526                	mv	a0,s1
     cc8:	00000097          	auipc	ra,0x0
     ccc:	142080e7          	jalr	322(ra) # e0a <close>
  return r;
}
     cd0:	854a                	mv	a0,s2
...
memmove(void *vdst, const void *vsrc, int n)
{
  ...
  src = vsrc;
  if (src > dst) {
     d32:	02b57663          	bgeu	a0,a1,d5e <memmove+0x32>
    while(n-- > 0)
     d36:	02c05163          	blez	a2,d58 <memmove+0x2c>
     d3a:	fff6079b          	addiw	a5,a2,-1
     d3e:	1782                	slli	a5,a5,0x20
     d40:	9381                	srli	a5,a5,0x20
     d42:	0785                	addi	a5,a5,1
     d44:	97aa                	add	a5,a5,a0
  dst = vdst;
     d46:	872a                	mv	a4,a0
      *dst++ = *src++;
     d48:	0585                	addi	a1,a1,1
     d4a:	0705                	addi	a4,a4,1
     d4c:	fff5c683          	lbu	a3,-1(a1)
     d50:	fed70fa3          	sb	a3,-1(a4)
    while(n-- > 0)
     d54:	fee79ae3          	bne	a5,a4,d48 <memmove+0x1c>
    src += n;
    while(n-- > 0)
      *--dst = *--src;
  }
  return vdst;
     ...
     d5c:	8082                	ret
    dst += n;
     d5e:	00c50733          	add	a4,a0,a2
    src += n;
     d62:	95b2                	add	a1,a1,a2
    while(n-- > 0)
     d64:	fec05ae3          	blez	a2,d58 <memmove+0x2c>
     d68:	fff6079b          	addiw	a5,a2,-1
     d6c:	1782                	slli	a5,a5,0x20
     d6e:	9381                	srli	a5,a5,0x20
     d70:	fff7c793          	not	a5,a5
     d74:	97ba                	add	a5,a5,a4
      *--dst = *--src;
     d76:	15fd                	addi	a1,a1,-1
     d78:	177d                	addi	a4,a4,-1
     d7a:	0005c683          	lbu	a3,0(a1)
     d7e:	00d70023          	sb	a3,0(a4)
    while(n-- > 0)
     d82:	fee79ae3          	bne	a5,a4,d76 <memmove+0x4a>
     d86:	bfc9                	j	d58 <memmove+0x2c>

0000000000000d88 <memcmp>:
...
memcmp(const void *s1, const void *s2, uint n)
{
  ...
  while (n-- > 0) {
     d8e:	ca05                	beqz	a2,dbe <memcmp+0x36>
     d90:	fff6069b          	addiw	a3,a2,-1
     d94:	1682                	slli	a3,a3,0x20
     d96:	9281                	srli	a3,a3,0x20
     d98:	0685                	addi	a3,a3,1
     d9a:	96aa                	add	a3,a3,a0
    if (*p1 != *p2) {
     d9c:	00054783          	lbu	a5,0(a0)
     da0:	0005c703          	lbu	a4,0(a1)
     da4:	00e79863          	bne	a5,a4,db4 <memcmp+0x2c>
      return *p1 - *p2;
    }
    p1++;
  ...
  while (n-- > 0) {
     dac:	fed518e3          	bne	a0,a3,d9c <memcmp+0x14>
  }
  return 0;
     db0:	4501                	li	a0,0
     db2:	a019                	j	db8 <memcmp+0x30>
      return *p1 - *p2;
     db4:	40e7853b          	subw	a0,a5,a4
}
     db8:	6422                	ld	s0,8(sp)
     dba:	0141                	addi	sp,sp,16
     dbc:	8082                	ret
  return 0;
     dbe:	4501                	li	a0,0
     dc0:	bfe5                	j	db8 <memcmp+0x30>

0000000000000dc2 <memcpy>:
...
memcpy(void *dst, const void *src, uint n)
{
  ...
  return memmove(dst, src, n);
     ...
     dce:	f62080e7          	jalr	-158(ra) # d2c <memmove>
}
     dd2:	60a2                	ld	ra,8(sp)
     dd4:	6402                	ld	s0,0(sp)
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     e98:	f6e080e7          	jalr	-146(ra) # e02 <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12f0:	b7e080e7          	jalr	-1154(ra) # e6a <sbrk>
  if(p == (char*)-1)
