...
print(const char *s)
{
  ...
  10:	08a080e7          	jalr	138(ra) # 96 <strlen>
  14:	0005061b          	sext.w	a2,a0
  18:	85a6                	mv	a1,s1
  1a:	4505                	li	a0,1
  1c:	00000097          	auipc	ra,0x0
  20:	2c8080e7          	jalr	712(ra) # 2e4 <write>
}
  24:	60e2                	ld	ra,24(sp)
  26:	6442                	ld	s0,16(sp)
  28:	64a2                	ld	s1,8(sp)
...
main(int argc, char *argv[])
{
  ...
  int i = 0;
  while(1){
  34:	a001                	j	34 <main+0x6>

0000000000000036 <_start>:
...
_start()
{
  ...
  42:	ff0080e7          	jalr	-16(ra) # 2e <main>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ac:	44050513          	addi	a0,a0,1088 # 7e8 <digits>
 3b0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 478:	374b8b93          	addi	s7,s7,884 # 7e8 <digits>
 ...
 5b8:	22c90913          	addi	s2,s2,556 # 7e0 <malloc+0xe6>
        while(*s != 0){
...
free(void *ap)
{
 ...
 680:	1847b783          	ld	a5,388(a5) # 800 <freep>
 ...
 6ae:	00e6ea63          	bltu	a3,a4,6c2 <free+0x50>
{
 ...
 6f0:	10f73a23          	sd	a5,276(a4) # 800 <freep>
}
 6f4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 722:	0e253503          	ld	a0,226(a0) # 800 <freep>
 ...
 74a:	0ba90913          	addi	s2,s2,186 # 800 <freep>
  if(p == (char*)-1)
 74e:	5afd                	li	s5,-1
 ...
 75e:	0af73323          	sd	a5,166(a4) # 800 <freep>
 762:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 784:	08a73023          	sd	a0,128(a4) # 800 <freep>
      return (void*)(p + 1);
 ...
 7d2:	b7e080e7          	jalr	-1154(ra) # 34c <sbrk>
  if(p == (char*)-1)
